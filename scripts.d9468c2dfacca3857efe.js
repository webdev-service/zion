! function (t, e) {
    ...
    var u = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i, a, s, r, n, o) {
                    ...
                    (!s || s.indexOf("undefined") > -1 || s.indexOf("NaN") > -1) && (s = c()), (!r || r.indexOf("undefined") > -1 || r.indexOf("NaN") > -1) && (r = c()), h.globals.shouldAnimate || (n = 1), t.plot(s).animate(1, h.globals.easing, o).plot(s).animate(n, h.globals.easing, o).plot(r).afterAll((function () {
                        u.isNumber(i) ? i === h.globals.series[h.globals.maxValsInArrayIndex].length - 2 && h.globals.shouldAnimate && l.animationCompleted(t) : "none" !== a && h.globals.shouldAnimate && (!h.globals.comboCharts && e === h.globals.series.length - 1 || h.globals.comboCharts) && l.animationCompleted(t), l.showDelayedElements()
                    }))
                }
            }]), t
        }(),
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
                        ...
                        h = this.w;
                    return t.unfilter(!0), u.isIE() && "radialBar" === h.config.chart.type || (n = Array.isArray(n) ? n[i] : n, t.filter((function (t) {
                        var e;
                        e = u.isSafari() || u.isFirefox() || u.isIE() ? t.flood(n, o).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(r) : t.flood(n, o).composite(t.sourceAlpha, "in").offset(s, a).gaussianBlur(r).merge(t.source), t.blend(t.source, e)
        ...
        x = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    }), "none" !== A.config.states.normal.filter.type ? S.getDefaultFilter(I, a) : A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledOnSeries || A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a)) && S.dropShadow(I, A.config.chart.dropShadow, a), y && (I.node.addEventListener("mouseenter", this.pathMouseEnter.bind(this, I)), I.node.addEventListener("mouseleave", this.pathMouseLeave.bind(this, I)), I.node.addEventListener("mousedown", this.pathMouseDown.bind(this, I))), I.attr({
                        pathTo: r,
                        pathFrom: s
                    });
                    var E = {
                    ...
                    return !L || A.globals.resized || A.globals.dataChanged ? !A.globals.resized && A.globals.dataChanged || C.showDelayedElements() : C.animatePathsGradually(n(n({}, E), {}, {
                        speed: g
                    })), A.globals.dataChanged && P && T && C.animatePathsGradually(n(n({}, E), {}, {
                        speed: u
                    })), I
                }
            }, {
                ...
                value: function (t, e, i, a, s) {
                    var r, n = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : null,
                        ...
                        c = this.w;
                    e.length < 9 && 0 === e.indexOf("#") && (e = u.hexToRgba(e, a)), i.length < 9 && 0 === i.indexOf("#") && (i = u.hexToRgba(i, s));
                    var d = 0,
                        g = 1,
                        p = 1,
                        f = null;
                    null !== o && (d = void 0 !== o[0] ? o[0] / 100 : 0, g = void 0 !== o[1] ? o[1] / 100 : 1, p = void 0 !== o[2] ? o[2] / 100 : 1, f = void 0 !== o[3] ? o[3] / 100 : null);
                    ...
                    if (r = c.globals.dom.Paper.gradient(x ? "radial" : "linear", null === l || 0 === l.length ? function (t) {
                            t.at(d, e, a), t.at(g, i, s), t.at(p, i, s), null !== f && t.at(f, e, a)
                        } : function (t) {
        ...
        b = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    ...
                    var h = this.annoCtx.graphics.drawRect(s.left - a.left - r - i.globals.barPadForNumericAxis, s.top - a.top - o, s.width + r + n, s.height + o + l, e.label.borderRadius, e.label.style.background, 1, e.label.borderWidth, e.label.borderColor, 0);
                ...
                value: function (t, e, i) {
                    ...
                    if (u.isNumber(o)) {
                        if (null == t.x2) {
                            ...
                            var p = this.annoCtx.graphics.drawRect(o + t.offsetX, 0 + t.offsetY, d - o, a.globals.gridHeight + t.offsetY, 0, t.fillColor, t.opacity, 1, t.borderColor, h);
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    ...
                    if (this.annoCtx.invertAxis) {
                        ...
                        var o;
                        o = s.config.yaxis[e.yAxisIndex].logarithmic ? (a = new v(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex] : (a - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight), i = s.globals.gridHeight - o, s.config.yaxis[e.yAxisIndex] && s.config.yaxis[e.yAxisIndex].reversed && (i = o)
                    }
                    return i
                }
            }, {
        ...
        w = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i) {
                    ...
                    if (o = a.config.yaxis[t.yAxisIndex].logarithmic ? (l = new v(this.annoCtx.ctx).getLogVal(l, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex] : (l - a.globals.minYArr[t.yAxisIndex]) / (a.globals.yRange[t.yAxisIndex] / a.globals.gridHeight), r = a.globals.gridHeight - o - parseFloat(t.label.style.fontSize) - t.marker.size, n = a.globals.gridHeight - o, a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (r = o + parseFloat(t.label.style.fontSize) + t.marker.size, n = o), u.isNumber(s)) {
                        var c = {
                                pSize: t.marker.size,
        ...
        S = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w, this.graphics = new x(this.ctx), this.w.globals.isBarHorizontal && (this.invertAxis = !0), this.helpers = new b(this), this.xAxisAnnotations = new m(this), this.yAxisAnnotations = new y(this), this.pointsAnnotations = new w(this), this.w.globals.isBarHorizontal && this.w.config.yaxis[0].reversed && (this.inversedReversedAxis = !0), this.xDivision = this.w.globals.gridWidth / this.w.globals.dataPoints
            }
            return a(t, [{
                ...
                value: function (t, e) {
                    var i = t.text,
                        ...
                        v = this.graphics.drawText({
                            ...
                            fontFamily: t.fontFamily || m.config.chart.fontFamily,
                            foreColor: t.foreColor || m.config.chart.foreColor,
                            cssClass: t.cssClass
                        }),
                        y = m.globals.dom.baseEl.querySelector(h);
                    y && y.appendChild(v.node);
                    var w = v.bbox();
                    if (i) {
                        var k = this.graphics.drawRect(w.x - d, w.y - b, w.width + d + u, w.height + f + b, n, a || "transparent", 1, s, o, r);
                        y.insertBefore(k.node, v.node)
                    }
                }
            }, {
                key: "addImage",
                ...
                value: function (t) {
                    ...
                    var p = o.globals.dom.baseEl.querySelector(".apexcharts-".concat(s, "-annotations .apexcharts-").concat(s, "-annotation-label[rel='").concat(h, "']")),
                        f = this.helpers.addBackgroundToAnno(p, g);
                ...
                value: function (t) {
                    ...
                    })), i = u.listToArray(i), Array.prototype.forEach.call(i, (function (t) {
        ...
        C = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    h.appendChild(c), c.setAttributeNS(window.SVG.xlink, "href", n), x.setAttrs(c, {
                        x: 0,
                        y: 0,
                ...
                value: function (t) {
                    ...
                    t.color && (n = t.color);
                    var h = n;
                    if (-1 === n.indexOf("rgb") ? n.length < 9 && (h = u.hexToRgba(n, l)) : n.indexOf("rgba") > -1 && (l = u.getOpacityFromRGBA(n)), t.opacity && (l = t.opacity), "pattern" === o && (a = this.handlePatternFill(a, n, l, h)), "gradient" === o && (s = this.handleGradientFill(n, l, this.seriesIndex)), "image" === o) {
                ...
                value: function (t, e, i) {
                    ...
                    h.indexOf("rgba") > -1 && (c = u.getOpacityFromRGBA(h));
                    ...
                    if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length) a = o.shadeColor("dark" === s.fill.gradient.shade ? -1 * parseFloat(s.fill.gradient.shadeIntensity) : parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? u.rgb2hex(t) : t);
                    else if (s.fill.gradient.gradientToColors[r.seriesNumber]) {
                        var g = s.fill.gradient.gradientToColors[r.seriesNumber];
                        a = g, g.indexOf("rgba") > -1 && (d = u.getOpacityFromRGBA(g))
                    } else a = t;
                    if (s.fill.gradient.inverseColors) {
                        var p = h;
                        h = a, a = p
                    }
                    return h.indexOf("rgb") > -1 && (h = u.rgb2hex(h)), a.indexOf("rgb") > -1 && (a = u.rgb2hex(a)), n.drawGradient(l, h, a, c, d, r.size, s.fill.gradient.stops, s.fill.gradient.colorStops, i)
                }
            }]), t
        }(),
        L = function () {
                ...
                value: function (t, e, i, a) {
                    ...
                    if ((n.globals.markers.size[e] > 0 || r) && (h = c.group({
                        ...
                        for (var d = 0; d < l.x.length; d++) {
                            ...
                            if (b || r) {
                                u.isNumber(l.y[d]) ? p += " w".concat(u.randomId()) : p = "apexcharts-nullpoint";
                                var m = this.getMarkerConfig(p, e, g);
        ...
        P = function () {
            ...
            return a(t, [{
                    ...
                    if (h.attr("clip-path", "url(#gridRectMarkerMask".concat(a.globals.cuid, ")")), Array.isArray(n.x))
                        for (var c = 0; c < n.x.length; c++) {
                            ...
                            if (u = u || 0, null !== b && void 0 !== a.globals.series[r][d] || (g = !1), g) {
                                var m = this.drawPoint(n.x[c], b, u, p, r, d, e);
                                h.add(m)
                            }
                            l.add(h)
                        }
                ...
                value: function (t, e, i, a, s, r, n) {
                    ...
                    if ("circle" === m.shape ? o = b.drawCircle(i) : "square" !== m.shape && "rect" !== m.shape || (o = b.drawRect(0, 0, m.width - m.pointStrokeWidth / 2, m.height - m.pointStrokeWidth / 2, m.pRadius)), l.config.series[h].data[r] && l.config.series[h].data[r].fillColor && (v = l.config.series[h].data[r].fillColor), o.attr({
                        ...
                        }), l.config.chart.dropShadow.enabled && d.dropShadow(o, l.config.chart.dropShadow, s), !this.initialAnim || l.globals.dataChanged || l.globals.resized ? l.globals.animationEnded = !0 : c.animateMarker(o, 0, "circle" === m.shape ? a : {
                            width: m.width,
                            height: m.height
                        ...
                        })), l.globals.dataChanged && "circle" === m.shape)
                        if (this.dynamicAnim) {
                            var y, w, k, A, S = l.config.chart.animations.dynamicAnimation.speed;
                            null != (A = l.globals.previousPaths[s] && l.globals.previousPaths[s][n]) && (y = A.x, w = A.y, k = void 0 !== A.r ? A.r : a);
                            for (var P = 0; P < l.globals.collapsedSeries.length; P++) l.globals.collapsedSeries[P].index === s && (S = 1, a = 0);
        ...
        T = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i, a, s, r, n) {
                    var o = this.w,
                        l = !1,
                        h = new x(this.ctx).getTextRects(i, n),
                        c = h.width,
                        d = h.height;
                    if (e < 0 && (e = 0), e > o.globals.gridHeight + d && (e = o.globals.gridHeight + d / 2), void 0 === o.globals.dataLabelsRects[a] && (o.globals.dataLabelsRects[a] = []), o.globals.dataLabelsRects[a].push({
                            x: t,
                            y: e,
                            width: c,
                            height: d
                        }), void 0 !== o.globals.dataLabelsRects[a][o.globals.dataLabelsRects[a].length - 2]) {
                        var g = o.globals.dataLabelsRects[a][void 0 !== o.globals.lastDrawnDataLabelsIndexes[a] ? o.globals.lastDrawnDataLabelsIndexes[a][o.globals.lastDrawnDataLabelsIndexes[a].length - 1] : 0];
                ...
                value: function (t) {
                    ...
                    if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(r) < 0)) {
                        ...
                        p && (b = this.dataLabelsCorrection(a, s, o, r, n, u, parseInt(d.style.fontSize, 10))), e.globals.zoomed || (a = b.x, s = b.y), b.textRects && (a < -10 - b.textRects.width || a > e.globals.gridWidth + b.textRects.width + 10) && (o = "");
                        ...
                        var v = d.offsetX,
                            y = d.offsetY;
                        if ("bar" !== e.config.chart.type && "rangeBar" !== e.config.chart.type || (v = 0, y = 0), b.drawnextLabel) {
                            var w = i.drawText({
                                width: 100,
                ...
                value: function (t, e) {
                    var i = this.w,
                        ...
                        n = e.width,
                        o = e.height,
                        l = new x(this.ctx).drawRect(e.x - s, e.y - r / 2, n + 2 * s, o + r, a.borderRadius, "transparent" === i.config.chart.background ? "#fff" : i.config.chart.background, a.opacity, a.borderWidth, a.borderColor);
                    return a.dropShadow.enabled && new f(this.ctx).dropShadow(l, a.dropShadow), l
                }
            }, {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    var e = t.x,
                        ...
                        m = e + parseFloat(c * g),
                        v = i + parseFloat(h * g);
                    p.globals.isXNumeric && !p.globals.isBarHorizontal && (m = e + parseFloat(c * (g + 1)), v = i + parseFloat(h * (g + 1)) - b);
                    var y, w = e,
                        k = i,
                    ...
                    p.config.dataLabels.enabled && (P = f.getTextRects(p.globals.yLabelFormatters[0](this.barCtx.series[r][n]), parseFloat(A.style.fontSize)));
                    var T = {
                        x: e,
                        y: i,
                        i: r,
                    ...
                    return y = this.barCtx.isHorizontal ? this.calculateBarsDataLabelsPosition(T) : this.calculateColumnsDataLabelsPosition(T), u.attr({
                        cy: y.bcy,
                        cx: y.bcx,
                        j: n,
                        val: l[r][n],
                ...
                value: function (t) {
                    ...
                    n -= g / 2, e = i.globals.isXNumeric ? n - o / 2 + u : n - i.globals.gridWidth / i.globals.dataPoints + o / 2 + u, f && (e = e + h.height / 2 - g / 2 - 2);
                    var x = this.barCtx.series[a][s] < 0,
                        b = r;
                    switch (this.barCtx.isReversed && (b = r - l + (x ? 2 * l : 0), r -= l), d.position) {
                        case "center":
                            c = f ? x ? b + l / 2 + p : b + l / 2 - p : x ? b - l / 2 + h.height / 2 + p : b + l / 2 + h.height / 2 - p;
                            break;
                        case "bottom":
                            c = f ? x ? b + l + p : b + l - p : x ? b - l + h.height + g + p : b + l - h.height / 2 + g - p;
                            break;
                        case "top":
                            c = f ? x ? b + p : b - p : x ? b - h.height / 2 - p : b + h.height + p
                    }
        ...
        M = function () {
            ...
            return a(t, [{
                ...
                key: "getSeriesByName",
                value: function (t) {
                    return this.w.globals.dom.baseEl.querySelector(".apexcharts-inner .apexcharts-series[seriesName='".concat(u.escapeString(t), "']"))
                }
            }, {
                key: "isSeriesHidden",
                value: function (t) {
                ...
                value: function () {
                    var t = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                        ...
                        a = this.w,
                        s = u.clone(a.globals.initialSeries);
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    if (this.barCtx.barOptions.colors.backgroundBarColors.length > 0 && c === i) {
                        ...
                        var d = h.drawRect(void 0 !== a ? a : 0, void 0 !== r ? r : 0, void 0 !== s ? s : l.globals.gridWidth, void 0 !== n ? n : l.globals.gridHeight, this.barCtx.barOptions.colors.backgroundBarRadius, this.barCtx.barOptions.colors.backgroundBarColors[e], this.barCtx.barOptions.colors.backgroundBarOpacity);
                ...
                value: function (t) {
                    ...
                    var u = this.getRoundedBars(d, {
                        ...
                        m = g.move(p, s),
                        v = g.line(f - n, s);
                    return d.globals.previousPaths.length > 0 && (m = this.barCtx.getPreviousPath(l, c, !1)), b = b + g.line(p, u.y2) + u.pathWithRadius + g.line(f - n, u.y2) + v + v + "z", m = m + g.line(p, s) + v + v + v + v + v + g.line(p, s), d.config.chart.stacked && (this.barCtx.yArrj.push(u.y2), this.barCtx.yArrjF.push(Math.abs(s - u.y2)), this.barCtx.yArrjVal.push(this.barCtx.series[h][c])), {
                        pathTo: b,
                        pathFrom: m
                    }
                }
                ...
                value: function (t) {
                    ...
                    var f = e,
                        b = e + i,
                        m = d.line(a, b - r);
                    return u = u + d.line(g.x2, f) + g.pathWithRadius + d.line(g.x2, b - r) + m + m + "z", p = p + d.line(a, f) + m + m + m + m + m + d.line(a, f), c.config.chart.stacked && (this.barCtx.xArrj.push(g.x2), this.barCtx.xArrjF.push(Math.abs(a - g.x2)), this.barCtx.xArrjVal.push(this.barCtx.series[l][h])), {
                        pathTo: u,
                        pathFrom: p
                    }
                }
                ...
                value: function (t, e, i, a, s) {
                    ...
                    if (t.config.chart.stacked && i.length > 1 && a !== this.barCtx.radiusOnSeriesNumber && (n = 0), this.barCtx.isHorizontal) {
                        ...
                        if (Math.abs(e.x1 - e.x2) < n && (n = Math.abs(e.x1 - e.x2)), void 0 !== i[a][s] || null !== i[a][s]) {
                            ...
                            h && (n *= -1), o = r.quadraticCurve((l -= n) + n, e.barYPosition, l + n, e.barYPosition + (h ? -1 * n : n)) + r.line(l + n, e.barYPosition + e.barHeight - e.strokeWidth - (h ? -1 * n : n)) + r.quadraticCurve(l + n, e.barYPosition + e.barHeight - e.strokeWidth, l, e.barYPosition + e.barHeight - e.strokeWidth)
                        }
                        return {
                            pathWithRadius: o,
                            x2: l
                    ...
                    if (Math.abs(e.y1 - e.y2) < n && (n = Math.abs(e.y1 - e.y2)), void 0 !== i[a][s] || null !== i[a][s]) {
                        var g = i[a][s] < 0;
                        g && (n *= -1), c = r.quadraticCurve(e.barXPosition, (d += n) - n, e.barXPosition + (g ? -1 * n : n), d - n) + r.line(e.barXPosition + e.barWidth - e.strokeWidth - (g ? -1 * n : n), d - n) + r.quadraticCurve(e.barXPosition + e.barWidth - e.strokeWidth, d - n, e.barXPosition + e.barWidth - e.strokeWidth, d)
                    }
                    return {
                        pathWithRadius: c,
                        y2: d
        ...
        E = function () {
            function t(i, a) {
                e(this, t), this.ctx = i, this.w = i.w;
                var s = this.w;
                this.barOptions = s.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = s.config.stroke.width, this.isNullValue = !1, this.isTimelineBar = "datetime" === s.config.xaxis.type && s.globals.seriesRangeBarTimeline.length, this.xyRatios = a, null !== this.xyRatios && (this.xRatio = a.xRatio, this.initialXRatio = a.initialXRatio, this.yRatio = a.yRatio, this.invertedXRatio = a.invertedXRatio, this.invertedYRatio = a.invertedYRatio, this.baseLineY = a.baseLineY, this.baseLineInvertedY = a.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0, this.barHelpers = new I(this)
            }
            return a(t, [{
                key: "draw",
                value: function (t, e) {
                    ...
                    for (var o = 0, l = 0; o < t.length; o++, l++) {
                        ...
                        f = S.y, k = S.barHeight, c = S.yDivision, g = S.zeroW, p = S.x, A = S.barWidth, h = S.xDivision, d = S.zeroH, this.horizontal || m.push(p + A / 2);
                        for (var C = a.group({
                            ...
                            this.isHorizontal ? (T = this.drawBarPaths(n(n({}, z), {}, {
                                ...
                                barWidth: A,
                                zeroH: d
                            })), k = this.series[o][L] / this.yRatio[this.yaxisIndex]), f = T.y, p = T.x, L > 0 && m.push(p + A / 2), b.push(f);
                            var M = this.barHelpers.getPathFillColor(t, o, L, y);
                            this.renderSeries({
                                realIndex: y,
                                pathFill: M,
                                j: L,
                ...
                value: function (t) {
                    ...
                    var C = S.renderPaths({
                        ...
                        fill: i,
                        animationDelay: s / A.config.chart.animations.animateGradually.delay * (A.config.chart.animations.speed / A.globals.dataPoints) / 2.4,
                    ...
                    C.attr("clip-path", "url(#gridRectMask".concat(A.globals.cuid, ")")), void 0 !== g && void 0 !== u && (C.attr("data-range-y1", g), C.attr("data-range-y2", u)), new f(this.ctx).setSelectionFilter(C, e, s), h.add(C);
                    var L = new z(this).handleBarDataLabels({
                        x: c,
                        y: d,
                        y1: g,
                        y2: u,
                ...
                value: function (t) {
                    var e, i = t.indexes,
                        ...
                        h = i.i,
                        c = i.j;
                    l.globals.isXNumeric && (r = (l.globals.seriesX[h][c] - l.globals.minX) / this.invertedXRatio - a);
                    var d = r + a * this.visibleI,
                        g = this.barHelpers.getBarpaths({
                            barYPosition: d,
                            barHeight: a,
                            x1: s,
                            x2: e = null == this.series[h][c] ? s : s + this.series[h][c] / this.invertedYRatio - 2 * (this.isReversed ? this.series[h][c] / this.invertedYRatio : 0),
                    ...
                    return l.globals.isXNumeric || (r += n), this.barHelpers.barBackground({
                        j: c,
                        i: h,
                        y1: d - a * this.visibleI,
                        y2: a * this.seriesLen,
                        elSeries: o
                    }), {
                        pathTo: g.pathTo,
                ...
                value: function (t) {
                    ...
                    var f = a + r * this.visibleI,
                        x = this.barHelpers.getColumnPaths({
                            ...
                            barWidth: r,
                            y1: n,
                            y2: e = null == this.series[d][g] ? n : n - this.series[d][g] / this.yRatio[this.yaxisIndex] + 2 * (this.isReversed ? this.series[d][g] / this.yRatio[this.yaxisIndex] : 0),
                            strokeWidth: o,
                            series: this.series,
                            realIndex: i.realIndex,
                            i: d,
        ...
        Y = function (t) {
            ...
            return a(s, [{
                ...
                value: function (t, e) {
                    ...
                    for (var s = a.group({
                        ...
                        var o, l, h, c = void 0,
                            ...
                            f = a.group({
                                class: "apexcharts-series",
                                seriesName: u.escapeString(i.globals.seriesNames[p]),
                                rel: r + 1,
                                "data:realIndex": p
                            });
                        ...
                        for (var y = a.group({
                            ...
                            var k = this.barHelpers.getStrokeWidth(r, w, p),
                            ...
                            if (g = v.yDivision, b = v.barHeight, this.isHorizontal) {
                                L = d + b * this.visibleI;
                                ...
                                if (this.isTimelineBar && i.config.series[r].data[w].x) {
                                    ...
                                    b = M.barHeight, L = M.barYPosition
                                }
                            ...
                            d = C.y, c = C.x;
                            var I = this.barHelpers.getPathFillColor(t, r, w, p);
                            this.renderSeries({
                                realIndex: p,
                                pathFill: I,
                ...
                value: function (t) {
                    ...
                    null == this.series[o][l] ? g = r : (g = r - g / h, u = r - u / h);
                    var f = Math.abs(u - g),
                        x = this.barHelpers.getColumnPaths({
                            barXPosition: p,
                            barWidth: s,
                ...
                value: function (t) {
                    var e = t.indexes,
                        ...
                        n = t.zeroW,
                        o = this.w,
                        l = n + t.y1 / this.invertedYRatio,
                        h = n + t.y2 / this.invertedYRatio,
                        c = Math.abs(h - l),
        ...
        F = function () {
            ...
            return a(t, [{
                ...
                key: "sparkline",
                value: function (t) {
                    return this.opts.yaxis[0].show = !1, this.opts.yaxis[0].title.text = "", this.opts.yaxis[0].axisBorder.show = !1, this.opts.yaxis[0].axisTicks.show = !1, this.opts.yaxis[0].floating = !0, u.extend(t, {
                        grid: {
                            show: !1,
                            padding: {
                                left: 0,
                ...
                value: function (t, e, i) {
                    t.xaxis.type = "numeric", t.xaxis.labels = t.xaxis.labels || {}, t.xaxis.labels.formatter = t.xaxis.labels.formatter || function (t) {
                        return u.isNumber(t) ? Math.floor(t) : t
                    };
                    ...
                    return i && i.length && (s = i.map((function (t) {
                        ...
                        return u.isNumber(t) ? a(s[Math.floor(t) - 1]) : a(t)
            ...
            return a(i, [{
                ...
                value: function (e) {
                    var i = e.responsiveOverride,
                        ...
                        s = new A,
                        r = new F(a);
                    this.chartType = a.chart.type, "histogram" === this.chartType && (a.chart.type = "bar", a = u.extend({
                        plotOptions: {
                            bar: {
                                columnWidth: "99.99%"
                            }
                    ...
                    if (a && "object" === t(a)) {
                        var l = {};
                        l = -1 !== ["line", "area", "bar", "candlestick", "boxPlot", "rangeBar", "histogram", "bubble", "scatter", "heatmap", "treemap", "pie", "polarArea", "donut", "radar", "radialBar"].indexOf(a.chart.type) ? r[a.chart.type]() : r.line(), a.chart.brush && a.chart.brush.enabled && (l = r.brush(l)), a.chart.stacked && "100%" === a.chart.stackType && (a = r.stacked100(a)), this.checkForDarkTheme(window.Apex), this.checkForDarkTheme(a), a.xaxis = a.xaxis || window.Apex.xaxis || {}, i || (a.xaxis.convertedCatToNumeric = !1), ((a = this.checkForCatToNumericXAxis(this.chartType, l, a)).chart.sparkline && a.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (l = r.sparkline(l)), o = u.extend(n, l)
                    }
                    var h = u.extend(o, window.Apex);
                    return n = u.extend(h, a), this.handleUserInputErrors(n)
                }
            }, {
                key: "checkForCatToNumericXAxis",
                value: function (t, e, i) {
                    var a = new F(i);
                    return "bar" === t && i.plotOptions && i.plotOptions.bar && i.plotOptions.bar.horizontal || "pie" === t || "polarArea" === t || "donut" === t || "radar" === t || "radialBar" === t || "heatmap" === t || !("datetime" !== i.xaxis.type && "numeric" !== i.xaxis.type) || "between" === (i.xaxis.tickPlacement ? i.xaxis.tickPlacement : e.xaxis && e.xaxis.tickPlacement) || (i = a.convertCatToNumeric(i)), i
                }
            }, {
                key: "extendYAxis",
                value: function (t, e) {
                    var i = new A;
                    (void 0 === t.yaxis || !t.yaxis || Array.isArray(t.yaxis) && 0 === t.yaxis.length) && (t.yaxis = {}), t.yaxis.constructor !== Array && window.Apex.yaxis && window.Apex.yaxis.constructor !== Array && (t.yaxis = u.extend(t.yaxis, window.Apex.yaxis)), t.yaxis = t.yaxis.constructor !== Array ? [u.extend(i.yAxis, t.yaxis)] : u.extendArray(t.yaxis, i.yAxis);
                    var a = !1;
                    ...
                    return e && !s && (s = e.config.series), a && s.length !== t.yaxis.length && s.length && (t.yaxis = s.map((function (e, a) {
                        ...
                        var r = u.extend(i.yAxis, t.yaxis[0]);
                        return r.show = !1, r
        ...
        D = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    return this.initGlobalVars(e), e.initialConfig = u.extend({}, t), e.initialSeries = u.clone(t.series), e.lastXAxis = u.clone(e.initialConfig.xaxis), e.lastYAxis = u.clone(e.initialConfig.yaxis), e
                }
            }]), t
        }(),
        H = function () {
        ...
        O = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w, this.twoDSeries = [], this.threeDSeries = [], this.twoDSeriesX = [], this.coreUtils = new v(this.ctx)
            }
            return a(t, [{
                key: "isMultiFormat",
                value: function () {
                ...
                value: function (t, e) {
                    for (var i = this.w.config, a = this.w.globals, s = "boxPlot" === i.chart.type || "boxPlot" === i.series[e].type, r = 0; r < t[e].data.length; r++)
                        if (void 0 !== t[e].data[r][1] && (Array.isArray(t[e].data[r][1]) && 4 === t[e].data[r][1].length && !s ? this.twoDSeries.push(u.parseNumber(t[e].data[r][1][3])) : this.twoDSeries.push(u.parseNumber(t[e].data[r].length >= 5 ? t[e].data[r][4] : t[e].data[r][1])), a.dataFormatXNumeric = !0), "datetime" === i.xaxis.type) {
                ...
                value: function (t, e) {
                    ...
                    for (var n = 0; n < t[e].data.length; n++) void 0 !== t[e].data[n].y && (Array.isArray(t[e].data[n].y) ? this.twoDSeries.push(u.parseNumber(t[e].data[n].y[t[e].data[n].y.length - 1])) : this.twoDSeries.push(u.parseNumber(t[e].data[n].y)));
                    for (var o = 0; o < t[r].data.length; o++) {
                        ...
                        l || c ? l || i.xaxis.convertedCatToNumeric ? "datetime" !== i.xaxis.type || a.isBarHorizontal && a.isRangeData ? (this.fallbackToCategory = !0, this.twoDSeriesX.push(t[r].data[o].x)) : this.twoDSeriesX.push(s.parseDate(t[r].data[o].x)) : "datetime" === i.xaxis.type ? this.twoDSeriesX.push(s.parseDate(t[r].data[o].x.toString())) : (a.dataFormatXNumeric = !0, a.isXNumeric = !0, this.twoDSeriesX.push(parseFloat(t[r].data[o].x))) : h ? (this.fallbackToCategory = !0, this.twoDSeriesX.push(t[r].data[o].x)) : (a.isXNumeric = !0, a.dataFormatXNumeric = !0, this.twoDSeriesX.push(t[r].data[o].x))
                    }
                ...
                value: function (t) {
                    ...
                    }))), e.xaxis.convertedCatToNumeric && (new F(e).convertCatToNumericXaxis(e, this.ctx, i.seriesX[0]), this._generateExternalLabels(t))) : this._generateExternalLabels(t)
                }
            }, {
        ...
        N = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i) {
                    var a = this.w;
                    return u.isNumber(t) && (t = t.toFixed(0 !== a.globals.yValueDecimal ? void 0 !== e.decimalsInFloat ? e.decimalsInFloat : a.globals.yValueDecimal : a.globals.maxYArr[i] - a.globals.minYArr[i] < 5 ? 1 : 0)), t
                }
            }, {
                    ...
                    return e.globals.xaxisTooltipFormatter = function (e) {
                        ...
                        if (u.isNumber(t)) {
                            if (!e.config.xaxis.convertedCatToNumeric && "numeric" === e.config.xaxis.type) {
                                if (u.isNumber(e.config.xaxis.decimalsInFloat)) return t.toFixed(e.config.xaxis.decimalsInFloat);
        ...
        W = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i, a) {
                    ...
                    var f = new x(this.ctx),
                        b = {};
                    b = n.globals.rotateXLabels ? f.getTextRects(l, parseInt(r, 10), null, "rotate(".concat(n.config.xaxis.labels.rotate, " 0 0)"), !1) : f.getTextRects(l, parseInt(r, 10));
                ...
                value: function (t) {
                    var e = this,
                        ...
                        g = function (t) {
                            ...
                            return Array.isArray(i) && (i = i.join(" ")), u.isNumber(i) ? i : i.split(a).join("")
                        };
                            ...
                            if (o.length && 0 === e && l.push(o.join(a)), t.data && t.data.length)
                                for (var s = 0; s < t.data.length; s++) {
                                    ...
                                    if (r || (c.isFormatXY() ? r = i[e].data[s].x : c.isFormat2DArray() && (r = i[e].data[s] ? i[e].data[s][0] : "")), 0 === e) {
                                        o.push("datetime" === n.config.xaxis.type && String(r).length >= 10 ? n.config.chart.toolbar.export.csv.dateFormatter(r) : u.isNumber(r) ? r : r.split(a).join(""));
        ...
        V = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w;
                var a = this.w;
                this.axesUtils = new W(i), this.xaxisLabels = a.globals.labels.slice(), a.globals.timescaleLabels.length > 0 && !a.globals.isBarHorizontal && (this.xaxisLabels = a.globals.timescaleLabels.slice()), this.drawnLabels = [], this.drawnLabelsRects = [], this.offY = "top" === a.config.xaxis.position ? 0 : a.globals.gridHeight + 1, this.offY = this.offY + a.config.xaxis.axisBorder.offsetY, this.isCategoryBarHorizontal = "bar" === a.config.chart.type && a.config.plotOptions.bar.horizontal, this.xaxisFontSize = a.config.xaxis.labels.style.fontSize, this.xaxisFontFamily = a.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = a.config.xaxis.labels.style.colors, this.xaxisBorderWidth = a.config.xaxis.axisBorder.width, this.isCategoryBarHorizontal && (this.xaxisBorderWidth = a.config.yaxis[0].axisBorder.width.toString()), this.xaxisBorderWidth = this.xaxisBorderWidth.indexOf("%") > -1 ? a.globals.gridWidth * parseInt(this.xaxisBorderWidth, 10) / 100 : parseInt(this.xaxisBorderWidth, 10), this.xaxisBorderHeight = a.config.xaxis.axisBorder.height, this.yaxis = a.config.yaxis[0]
            }
            return a(t, [{
                key: "drawXaxis",
                value: function () {
                    ...
                    var h = o.length;
                    n = i.globals.isXNumeric ? n + (t = i.globals.gridWidth / (h > 1 ? h - 1 : h)) / 2 + i.config.xaxis.labels.offsetX : n + (t = i.globals.gridWidth / o.length) + i.config.xaxis.labels.offsetX;
                    ...
                    if (i.config.xaxis.axisBorder.show) {
                        var p = i.globals.barPadForNumericAxis,
                            f = a.drawLine(i.globals.padHorizontal + i.config.xaxis.axisBorder.offsetX - p, this.offY, this.xaxisBorderWidth + p, this.offY, i.config.xaxis.axisBorder.color, 0, this.xaxisBorderHeight);
                        s.add(f)
                    }
                    return s
                }
                ...
                value: function (t) {
                    ...
                    if (g.show)
                        for (var u = function (n) {
                                ...
                                if (f.textContent = o.text, p.node.appendChild(f), 0 !== s.config.yaxis[t].labels.rotate) {
                ...
                value: function (t, e) {
                    ...
                    if (!(t < 0 || t - 2 > i.globals.gridWidth)) {
                        ...
                        if ("top" === i.config.xaxis.position && (r = s - i.config.xaxis.axisTicks.height), i.config.xaxis.axisTicks.show) {
                            var n = new x(this.ctx).drawLine(t + i.config.xaxis.axisTicks.offsetX, s + i.config.xaxis.offsetY, a + i.config.xaxis.axisTicks.offsetX, r + i.config.xaxis.offsetY, i.config.xaxis.axisTicks.color);
                ...
                value: function () {
                    ...
                    if (t.globals.timescaleLabels.length > 0)
                        ...
                        for (var r = i, n = 0; n < r; n++) {
                            var o = r;
                            t.globals.isXNumeric && "bar" !== t.config.chart.type && (o -= 1), e.push(a += t.globals.gridWidth / o)
                        }
                    return e
                }
            }, {
                ...
                value: function () {
                    ...
                    if (t.globals.rotateXLabels || t.config.xaxis.labels.rotateAlways)
                        for (var n = 0; n < a.length; n++) {
                            ...
                            o.y = o.y - 1, o.x = o.x + 1, a[n].setAttribute("transform", "rotate(".concat(t.config.xaxis.labels.rotate, " ").concat(o.x, " ").concat(o.y, ")")), a[n].setAttribute("text-anchor", "end"), i.setAttribute("transform", "translate(0, ".concat(-10, ")")), t.config.xaxis.labels.trim && Array.prototype.forEach.call(a[n].childNodes, (function (i) {
                    ...
                    if (s.length > 0) {
                        ...
                        for (var c = 0; c < r.length; c++) e.placeTextWithEllipsis(r[c], r[c].textContent, t.config.yaxis[0].labels.maxWidth - 2 * parseFloat(t.config.yaxis[0].title.style.fontSize) - 20)
                    }
                }
            }]), t
        }(),
        G = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w;
                var a = this.w;
                this.xaxisLabels = a.globals.labels.slice(), this.axesUtils = new W(i), this.isTimelineBar = "datetime" === a.config.xaxis.type && a.globals.seriesRangeBarTimeline.length, a.globals.timescaleLabels.length > 0 && (this.xaxisLabels = a.globals.timescaleLabels.slice())
            }
            return a(t, [{
                key: "drawGridArea",
                value: function () {
                ...
                value: function (t) {
                    var e = t.i,
                        i = t.x1,
                        a = this.w;
                    0 === e && a.globals.skipFirstTimelinelabel || e === t.xCount - 1 && a.globals.skipLastTimelinelabel && !a.config.xaxis.labels.formatter || "radar" === a.config.chart.type || (a.config.grid.xaxis.lines.show && this._drawGridLine({
                        x1: i,
                        y1: t.y1,
                        x2: t.x2,
                        y2: t.y2,
                        parent: t.parent
                    }), new V(this.ctx).drawXaxisTicks(i, this.elg))
                }
            }, {
                key: "_drawGridLine",
                value: function (t) {
                    var e = t.x1,
                        ...
                        c = new x(this).drawLine(e - (o ? h : 0), i, a + (o ? h : 0), s, n.config.grid.borderColor, l);
                ...
                value: function (t) {
                    ...
                    if ("column" !== n || "datetime" !== o.config.xaxis.type) {
                        var c = l.drawRect(i - ("row" === n ? h : 0), a, s + ("row" === n ? 2 * h : 0), r, 0, o.config.grid[n].colors[e], o.config.grid[n].opacity);
                ...
                value: function (t) {
                    ...
                    if (s.config.grid.xaxis.lines.show || s.config.xaxis.axisTicks.show) {
                        ...
                        s.globals.timescaleLabels.length ? function (t) {
                            for (var a = t.xC, s = t.y1, r = t.y2, n = 0; n < a; n++) e._drawGridLines({
                                i: n,
                                x1: e.xaxisLabels[n].position,
                                y1: s,
                                x2: e.xaxisLabels[n].position,
                                y2: r,
                                xCount: i,
                ...
                value: function (t) {
                    ...
                    if (i.config.grid.xaxis.lines.show || i.config.xaxis.axisTicks.show)
                        ...
                        }), new V(this.ctx).drawXaxisTicks(s, this.elg), a = s = s + i.globals.gridWidth / e + .3;
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 10,
                        ...
                        r = this.w,
                        n = Math.abs(e - t);
                    if ("dataPoints" === (i = this._adjustTicksForSmallRange(i, a, n)) && (i = r.globals.dataPoints - 1), t === Number.MIN_VALUE && 0 === e || !u.isNumber(t) && !u.isNumber(e) || t === Number.MIN_VALUE && e === -Number.MAX_VALUE) {
                    ...
                    var v = t;
                    (l = []).push(v);
                    for (var y = Math.abs(e - t) / i, w = 0; w <= i; w++) l.push(v += y);
                ...
                value: function (t, e, i) {
                    ...
                    if (void 0 !== e && this.w.config.yaxis[e].labels.formatter && void 0 === this.w.config.yaxis[e].tickAmount) {
                        ...
                        u.isNumber(Number(s)) && !u.isFloat(s) && (a = Math.ceil(i))
                    }
                    return a < t ? a : t
                }
            }, {
                ...
                value: function (t, e, i) {
                    ...
                    var n = Math.abs(i - e);
                    r.logarithmic && n <= 5 && (a.invalidLogScale = !0), r.logarithmic && n > 5 ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i)) : i !== -Number.MAX_VALUE && u.isNumber(i) ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = void 0 === r.min && void 0 === r.max || r.forceNiceScale ? this.niceScale(e, i, r.tickAmount ? r.tickAmount : n < 5 && n > 1 ? n + 1 : 5, t, void 0 === s.yaxis[t].max && void 0 === s.yaxis[t].min || s.yaxis[t].forceNiceScale) : this.linearScale(e, i, r.tickAmount, t)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
                }
            }, {
                key: "setXScale",
                value: function (t, e) {
                    var i = this.w,
                        ...
                        s = i.config.xaxis,
                        r = Math.abs(e - t);
                    return a.xAxisScale = e !== -Number.MAX_VALUE && u.isNumber(e) ? this.linearScale(t, e, s.tickAmount ? s.tickAmount : r < 5 && r > 1 ? r + 1 : 5, 0) : this.linearScale(0, 5, 5), a.xAxisScale
                }
            }, {
                ...
                value: function () {
                    ...
                    i.yaxis.forEach((function (e, n) {
                        ...
                        i.series.forEach((function (t, i) {
                            t.name === e.seriesName && (o = i, r.push(n !== i ? {
                                index: i,
                                similarIndex: n,
                                alreadyExists: !0
                            } : {
                ...
                value: function (t, e, i) {
                    ...
                    return e.forEach((function (t, n) {
                        ...
                        a.globals.series.forEach((function (n, l) {
                            var p = n[o];
                            r ? (h = c = p = u[o], u.forEach((function (t, e) {
                ...
                value: function () {
                    ...
                    if (t.isXNumeric && function () {
                            for (var e = 0; e < t.series.length; e++)
                                if (t.labels[e])
                                    for (var i = 0; i < t.labels[e].length; i++) null !== t.labels[e][i] && u.isNumber(t.labels[e][i]) && (t.maxX = Math.max(t.maxX, t.labels[e][i]), t.initialMaxX = Math.max(t.maxX, t.labels[e][i]), t.minX = Math.min(t.minX, t.labels[e][i]), t.initialMinX = Math.min(t.minX, t.labels[e][i]))
                ...
                value: function () {
                    ...
                    if (t.series.length)
                        for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++)
                            for (var s = 0, r = 0, n = 0; n < t.series.length; n++) null !== t.series[n][a] && u.isNumber(t.series[n][a]) && (t.series[n][a] > 0 ? s = s + parseFloat(t.series[n][a]) + 1e-4 : r += parseFloat(t.series[n][a])), n === t.series.length - 1 && (e.push(s), i.push(r));
        ...
        U = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w;
                var a = this.w;
                this.xaxisFontSize = a.config.xaxis.labels.style.fontSize, this.axisFontFamily = a.config.xaxis.labels.style.fontFamily, this.xaxisForeColors = a.config.xaxis.labels.style.colors, this.isCategoryBarHorizontal = "bar" === a.config.chart.type && a.config.plotOptions.bar.horizontal, this.xAxisoffX = 0, "bottom" === a.config.xaxis.position && (this.xAxisoffX = a.globals.gridHeight), this.drawnLabels = [], this.axesUtils = new W(i)
            }
            return a(t, [{
                key: "drawYaxis",
                value: function (t) {
                    ...
                    if (i.config.yaxis[t].labels.show)
                        for (var b = function (l) {
                                ...
                                if (l === c && (f = v), h.add(v), 0 !== i.config.yaxis[t].labels.rotate) {
                                    var y = a.rotateAroundCenter(f.node),
                ...
                value: function (t, e, i, a) {
                    ...
                    return void 0 === s.config.yaxis[t].title.text || t < 0 ? {
                        xPos: n,
                        padd: 0
                    } : (a ? (n = e.width + s.config.yaxis[t].title.offsetX + i.width / 2 + o / 2, 0 === (r += 1) && (n -= o / 2)) : (n = -1 * e.width + s.config.yaxis[t].title.offsetX + o / 2 + i.width / 2, s.globals.isBarHorizontal && (n = -1 * e.width - s.config.yaxis[t].title.offsetX - (o = 25))), {
                        xPos: n,
                        padd: o
                    })
                }
        ...
        q = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w, this.documentEvent = u.bind(this.documentEvent, this)
            }
            return a(t, [{
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    if (t.config.xaxis.crosshairs.show) {
                        ...
                        var g = e.drawRect();
                        1 === t.config.xaxis.crosshairs.width && (g = e.drawLine()), g.attr({
                    ...
                    if (0 !== a.responsive.length) {
                        ...
                        var r = new R({}),
                            n = function () {
                                ...
                                if (n > a) {
                                    var o = v.extendArrayProps(r, i.globals.initialConfig, i);
                                    t = u.extend(o, t), t = u.extend(i.config, t), e.overrideResponsiveOptions(t)
                                } else
                                    for (var l = 0; l < s.length; l++) n < s[l].breakpoint && (t = v.extendArrayProps(r, s[l].options, i), t = u.extend(i.config, t), e.overrideResponsiveOptions(t))
                            };
                        if (t) {
                            var o = v.extendArrayProps(r, t, i);
                            o = u.extend(i.config, o), n(o = u.extend(o, t))
                        } else n({})
                    }
                }
            }, {
        ...
        et = function () {
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    var i = Object.assign({}, u.getBoundingClientRect(e));
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    if (void 0 !== t.config.xaxis.title.text) {
                        var a = new x(this.dCtx.ctx).getTextRects(t.config.xaxis.title.text, t.config.xaxis.title.style.fontSize);
                ...
                value: function () {
                    ...
                    return 1.05 * (t = new x(this.dCtx.ctx).getTextRects(a, e.config.xaxis.labels.style.fontSize)).width * i.length > e.globals.gridWidth && 0 !== e.config.xaxis.labels.rotate && (e.globals.overlappingXLabels = !0), t
                }
            }, {
                    ...
                    return e.config.yaxis.map((function (r, n) {
                        ...
                        if (!s.isYAxisHidden(n) && r.labels.show && o.result.length) {
                            ...
                            if (void 0 !== d && 0 !== d.length || (d = c), e.globals.isBarHorizontal) {
                                ...
                                d = l(d = u.getLargestStringFromArr(p), {
                                    seriesIndex: n,
                                    dataPointIndex: -1,
                                    w: e
                                }), g = t.dCtx.dimHelpers.getLargestStringFromMultiArr(d, p)
                            }
                            var f = new x(t.dCtx.ctx),
                                b = "rotate(".concat(r.labels.rotate, " 0 0)"),
                                m = f.getTextRects(d, r.labels.style.fontSize, r.labels.style.fontFamily, b, !1),
                                v = m;
                            d !== g && (v = f.getTextRects(g, r.labels.style.fontSize, r.labels.style.fontFamily, b, !1)), i.push({
                ...
                value: function () {
                    ...
                    return this.w.config.yaxis.map((function (i, a) {
                        if (i.show && void 0 !== i.title.text) {
                            var s = new x(t.dCtx.ctx),
                                r = "rotate(".concat(i.title.rotate, " 0 0)"),
                                n = s.getTextRects(i.title.text, i.title.style.fontSize, i.title.style.fontFamily, r, !1);
                            e.push({
                                width: n.width,
                                height: n.height
                            })
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    if (e.globals.comboBarCount > 0 && (r = e.globals.comboBarCount), e.globals.collapsedSeries.forEach((function (t) {
                        ...
                        l <= 3 && (l = e.globals.dataPoints), n = l / t, e.globals.minXDiff && e.globals.minXDiff / n > 0 && (o = e.globals.minXDiff / n), o > t / 2 && (o /= 2), (s = o / r * parseInt(e.config.plotOptions.bar.columnWidth, 10) / 100) < 1 && (s = 1), e.globals.barPadForNumericAxis = s = s / (r > 1 ? 1 : 1.5) + 5
                    }
                    return s
                }
            }, {
        ...
        rt = function () {
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    this.dimGrid.setGridXPosForDualYAxis(s, a), new U(this.ctx).setYAxisXPosition(a, s)
                }
            }, {
                ...
                value: function (t, e) {
                    ...
                    if (a.globals.axisCharts || "radialBar" === a.config.chart.type) {
                        ...
                        if ("pie" === o || "polarArea" === o || "donut" === o) {
                            ...
                            new x(this.lgCtx.ctx).pathMouseDown(n.members[0], null), this.lgCtx.ctx.pie.printDataLabelsInner(n.members[0].node, l)
                        }
                        n.fire("click")
                    }
                }
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    if ((i.legend.showForSingleSeries && 1 === e.series.length || this.isBarsDistributed || e.series.length > 1 || !e.axisCharts) && i.legend.show) {
                        ...
                        this.drawLegends(), u.isIE11() ? document.getElementsByTagName("head")[0].appendChild(this.legendHelpers.getLegendStyles()) : this.legendHelpers.appendToForeignObject(), "bottom" === i.legend.position || "top" === i.legend.position ? this.legendAlignHorizontal() : "right" !== i.legend.position && "left" !== i.legend.position || this.legendAlignVertical()
                    }
                }
            }, {
                key: "drawLegends",
                ...
                value: function (t, e) {
                    ...
                    a.style.position = "absolute", n = n + e + i.config.legend.offsetY, a.style.left = (r = r + t + i.config.legend.offsetX) + "px", a.style.top = n + "px", "bottom" === i.config.legend.position ? (a.style.top = "auto", a.style.bottom = 5 - i.config.legend.offsetY + "px") : "right" === i.config.legend.position && (a.style.left = "auto", a.style.right = 25 + i.config.legend.offsetX + "px"), ["width", "height"].forEach((function (t) {
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    r.forEach((function (t, e) {
                        t.index && u.moveIndexInArray(r, e, t.index)
                    }));
                    for (var h = 0; h < r.length; h++) x.setAttrs(r[h].el, {
                        class: r[h].class,
                        title: r[h].title
                ...
                value: function (t) {
                    this.elMenuItems = [], t.appendChild(this.elMenu), x.setAttrs(this.elMenu, {
                    ...
                    for (var i = 0; i < e.length; i++) this.elMenuItems.push(document.createElement("div")), this.elMenuItems[i].innerHTML = e[i].title, x.setAttrs(this.elMenuItems[i], {
                    ...
                    if (void 0 !== t || void 0 !== e) {
                        if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
                            ...
                            var r = {
                                ...
                                n = u.clone(i.globals.initialConfig.yaxis);
                            i.config.chart.zoom.autoScaleYaxis && (n = new _(this.ctx).autoScaleY(this.ctx, n, {
                                xaxis: a
                ...
                value: function (t) {
                    this.ctx.getSyncedCharts().forEach((function (t) {
                        ...
                        var a = t.ctx.series.emptyCollapsedSeries(u.clone(e.globals.initialSeries));
        ...
        ht = function (t) {
            ...
            function s(t) {
                var a;
                return e(this, s), (a = i.call(this, t)).ctx = t, a.w = t.w, a.dragged = !1, a.graphics = new x(a.ctx), a.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], a.clientX = 0, a.clientY = 0, a.startX = 0, a.endX = 0, a.dragX = 0, a.startY = 0, a.endY = 0, a.dragY = 0, a.moveDirection = "none", a
            }
            return a(s, [{
                key: "init",
                value: function (t) {
                ...
                value: function (t) {
                    ...
                    if (this.dragged || null !== o.globals.selection) {
                        ...
                        }), x.setAttrs(l.node, c)), o.globals.selectionEnabled && (h.attr({
                            x: e,
                            y: i,
                            width: a > 0 ? a : 0,
                            height: s > 0 ? s : 0,
                ...
                value: function (t) {
                    var e, i = t.zoomtype,
                        ...
                        d = s.clientY - r.top - o;
                    return Math.abs(c + n) > a.globals.gridWidth ? c = a.globals.gridWidth - n : s.clientX - r.left < 0 && (c = n), n > s.clientX - r.left && (l = !0, c = Math.abs(c)), o > s.clientY - r.top && (h = !0, d = Math.abs(d)), s.drawSelectionRect(e = "x" === i ? {
                        x: l ? n - c : n,
                        y: 0,
                        width: c,
                ...
                value: function (t) {
                    ...
                    if (a.startX > a.endX) {
                        var n = a.startX;
                        a.startX = a.endX, a.endX = n
                    }
                    if (a.startY > a.endY) {
                        var o = a.startY;
                        a.startY = a.endY, a.endY = o
                    }
                    var l = void 0,
                        h = void 0;
                    i.globals.isTimelineBar ? (l = i.globals.yAxisScale[0].niceMin + a.startX * s.invertedYRatio, h = i.globals.yAxisScale[0].niceMin + a.endX * s.invertedYRatio) : (l = i.globals.xAxisScale.niceMin + a.startX * s.xRatio, h = i.globals.xAxisScale.niceMin + a.endX * s.xRatio);
                    var c = [],
                        d = [];
                    if (i.config.yaxis.forEach((function (t, e) {
                        ...
                        if (i.globals.zoomEnabled) {
                            var g = u.clone(i.globals.initialConfig.yaxis),
                                p = u.clone(i.globals.initialConfig.xaxis);
                            if (i.globals.zoomed = !0, i.config.xaxis.convertedCatToNumeric && (l = Math.floor(l), h = Math.floor(h), l < 1 && (l = 1, h = i.globals.dataPoints), h - l < 2 && (h = l + 1)), "xy" !== e && "x" !== e || (p = {
                                    min: l,
                                    max: h
                            ...
                            if (r) {
                                ...
                                x && (p = x.xaxis ? x.xaxis : p, g = x.yaxis ? x.yaxis : g)
                            }
                            var b = {
                                xaxis: p
                            };
                            i.config.chart.group || (b.yaxis = g), a.ctx.updateHelpers._updateOptions(b, !1, a.w.config.chart.animations.dynamicAnimation.enabled), "function" == typeof i.config.chart.events.zoomed && r.zoomCallback(p, g)
                        } else if (i.globals.selectionEnabled) {
                        var m, v = null;
                        m = {
                            min: l,
                            max: h
                        }, "xy" !== e && "y" !== e || (v = u.clone(i.config.yaxis)).forEach((function (t, e) {
                            v[e].min = d[e], v[e].max = c[e]
                ...
                value: function (t, e) {
                    var i = this.w,
                        a = this.xyRatios,
                        s = u.clone(i.globals.initialConfig.yaxis),
                        r = a.xRatio,
                        n = i.globals.minX,
                        o = i.globals.maxX;
            ...
            return a(t, [{
                ...
                value: function (t) {
                    var e = t.hoverArea,
                        ...
                        n = r / (s.globals.dataPoints - 1),
                        o = s.globals.gridHeight / s.globals.dataPoints,
                        l = t.elGrid.getBoundingClientRect(),
                        h = this.hasBars();
                    !s.globals.comboCharts && !h || s.config.xaxis.convertedCatToNumeric || (n = r / s.globals.dataPoints);
                    var c = i - l.left - s.globals.barPadForNumericAxis,
                        d = a - l.top;
                    c < 0 || d < 0 || c > s.globals.gridWidth || d > s.globals.gridHeight ? (e.classList.remove("hovering-zoom"), e.classList.remove("hovering-pan")) : s.globals.zoomEnabled ? (e.classList.remove("hovering-pan"), e.classList.add("hovering-zoom")) : s.globals.panEnabled && (e.classList.remove("hovering-zoom"), e.classList.add("hovering-pan"));
                    var g = Math.round(c / n),
                        p = Math.floor(d / o);
                    h && !s.config.xaxis.convertedCatToNumeric && (g = Math.ceil(c / n), g -= 1);
                    for (var f, x = null, b = null, m = [], v = 0; v < s.globals.seriesXvalues.length; v++) m.push([s.globals.seriesXvalues[v][0] - 1e-6].concat(s.globals.seriesXvalues[v]));
                    ...
                    })), s.globals.isXNumeric && (x = (b = this.closestInMultiArray(c, d, m, f)).index, g = b.j, null !== x && (g = (b = this.closestInArray(c, m = s.globals.seriesXvalues[x])).index)), s.globals.capturedSeriesIndex = null === x ? -1 : x, (!g || g < 1) && (g = 0), s.globals.capturedDataPointIndex = g, {
                        capturedSeries: x,
                        j: s.globals.isBarHorizontal ? p : g,
                        hoverX: c,
                        hoverY: d
                    }
                }
                ...
                value: function (t, e, i, a) {
                    ...
                    return a.map((function (s, o) {
                        s.map((function (s, d) {
                            var g = Math.abs(e - a[o][d]),
                                u = Math.abs(t - i[o][d]),
                                p = u + g;
                            p < c && (c = p, l = u, h = g, r = o, n = d)
                        }))
                    })), {
                        index: r,
                        j: n
            ...
            return a(t, [{
                ...
                value: function (t) {
                    var e, i = this,
                        ...
                        u = r.xAxisTTVal,
                        p = "",
                        f = c.globals.colors[a];
                    null !== s && c.config.plotOptions.bar.distributed && (f = c.globals.colors[s]);
                    for (var x = function (t, r) {
                            ...
                            p = i.getSeriesName({
                                ...
                                seriesIndex: a,
                                j: s
                            }), "treemap" === c.config.chart.type && (p = x.yLbTitleFormatter(String(c.config.series[a].data[s].x), {
                            ...
                            if (c.globals.axisCharts) {
                                ...
                                l ? (x = i.getFormatters(b), p = i.getSeriesName({
                                    fn: x.yLbTitleFormatter,
                                    index: b,
                                    seriesIndex: a,
                                    j: s
                                }), f = c.globals.colors[b], e = m(b)) : (h && h.target && h.target.getAttribute("fill") && (f = h.target.getAttribute("fill")), e = m(a))
                            }
                ...
                value: function (t) {
                    ...
                    f && (f.innerHTML = void 0 !== h ? h : ""), u[0] && u[0].classList.contains("apexcharts-tooltip-marker") && (o.config.tooltip.marker.fillColors && Array.isArray(o.config.tooltip.marker.fillColors) && (n = o.config.tooltip.marker.fillColors[e]), u[0].style.backgroundColor = n), o.config.tooltip.marker.show || (u[0].style.display = "none"), null !== g && (i[e].querySelector(".apexcharts-tooltip-text-z-label").innerHTML = o.config.tooltip.z.title, i[e].querySelector(".apexcharts-tooltip-text-z-value").innerHTML = void 0 !== g ? g : ""), r && u[0] && (u[0].parentNode.style.display = null == h || o.globals.collapsedSeriesIndices.indexOf(e) > -1 ? "none" : o.config.tooltip.items.display)
                }
            }, {
                ...
                value: function (t) {
                    ...
                    var d = r;
                    return r = a.globals.isXNumeric && "datetime" === a.config.xaxis.type ? new N(this.ctx).xLabelFormat(a.globals.ttKeyFormatter, d, d, {
                        i: void 0,
                        dateFormatter: new X(this.ctx).formatDate,
                        w: this.w
        ...
        gt = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    var e = this.ttCtx;
                    null !== e.ycrosshairs && x.setAttrs(e.ycrosshairs, {
                        y1: t,
                        y2: t
                    }), null !== e.ycrosshairsHidden && x.setAttrs(e.ycrosshairsHidden, {
                        y1: t,
                        y2: t
                    })
                }
                ...
                value: function (t) {
                    ...
                    if (null !== i.xaxisTooltip) {
                        ...
                        t -= i.xaxisTooltip.getBoundingClientRect().width / 2, isNaN(t) || (t += e.globals.translateX, a = new x(this.ctx).getTextRects(i.xaxisTooltipText.innerHTML), i.xaxisTooltipText.style.minWidth = a.width + "px", i.xaxisTooltip.style.left = t + "px", i.xaxisTooltip.style.top = s + "px")
                    }
                }
            }, {
                ...
                value: function (t) {
                    ...
                    e.globals.isXNumeric ? (n -= a % 2 != 0 ? l / 2 : 0, r && (r.classList.contains("apexcharts-candlestick-area") || r.classList.contains("apexcharts-boxPlot-area")) && e.globals.comboCharts && (n -= l / 2)) : e.globals.isBarHorizontal || (n = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2, isNaN(n) && (n = i.xAxisTicksPositions[t] - i.dataPointsDividedWidth / 2)), e.globals.isBarHorizontal ? o += h / 3 : o = i.e.clientY - c.top - i.tooltipRect.ttHeight / 2, e.globals.isBarHorizontal || this.moveXCrosshairs(n), i.fixedTooltip || this.moveTooltip(n, o || e.globals.gridHeight)
                }
            }]), t
        }(),
        ut = function () {
            ...
            return a(t, [{
                ...
                value: function () {
                    for (var t = this.w.globals.dom.baseEl.querySelectorAll(".apexcharts-series:not(.apexcharts-series-collapsed) .apexcharts-marker"), e = 0; e < t.length; e++) {
                        ...
                        u.isNumber(i) && i >= 0 ? t[e].setAttribute("r", i) : t[e].setAttribute("r", 0)
                    }
                }
            }]), t
        }(),
        pt = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    if (e.target.classList.contains("apexcharts-".concat(t.type, "-rect"))) {
                        ...
                        if (r.tooltipLabels.drawSeriesTexts({
                            ...
                            var u = n.globals.dom.elWrap.getBoundingClientRect();
                            a = n.globals.clientX - u.left - r.tooltipRect.ttWidth / 2, s = n.globals.clientY - u.top - r.tooltipRect.ttHeight - 5
                        }
                    }
                    return {
                        x: a,
                ...
                value: function (t) {
                    ...
                    if (a.target.classList.contains("apexcharts-marker")) {
                        ...
                        if (l.tooltipLabels.drawSeriesTexts({
                            ...
                            n = l.e.clientY + o.globals.translateY - p.top
                        }
                ...
                value: function (t) {
                    ...
                    if (h + n.tooltipRect.ttWidth > r.globals.gridWidth && !f ? h -= n.tooltipRect.ttWidth : h < 0 && (h = 0), n.w.config.tooltip.followCursor) {
                        var x = n.getElGrid().getBoundingClientRect();
                        c = n.e.clientY - x.top
                    }
                    null === n.tooltip && (n.tooltip = r.globals.dom.baseEl.querySelector(".apexcharts-tooltip")), r.config.tooltip.shared || n.tooltipPosition.moveXCrosshairs(r.globals.comboBarCount > 0 ? l + i / 2 : l), !n.fixedTooltip && (!r.config.tooltip.shared || r.globals.isBarHorizontal && n.tooltipUtil.hasBars()) && (f && (h -= n.tooltipRect.ttWidth) < 0 && (h = 0), o.style.left = h + r.globals.translateX + "px", !f || r.globals.isBarHorizontal && n.tooltipUtil.hasBars() || (c = c + g - 2 * (r.globals.series[e][u] < 0 ? g : 0)), o.style.top = n.tooltipRect.ttHeight + c > r.globals.gridHeight ? (c = r.globals.gridHeight - n.tooltipRect.ttHeight + r.globals.translateY) + "px" : c + r.globals.translateY - n.tooltipRect.ttHeight / 2 + "px")
                }
            }, {
                key: "getBarTooltipXY",
                value: function (t) {
            ...
            return a(t, [{
                ...
                value: function () {
                    ...
                    if (e.xcrosshairsWidth = parseInt(t.config.xaxis.crosshairs.width, 10), t.globals.comboCharts) {
                        ...
                        if (null !== r) {
                            var n = parseFloat(r.getAttribute("barWidth"));
                ...
                value: function (t, e, i) {
                    ...
                    if (a.yaxisTooltips[t]) {
                        var n = a.getElGrid().getBoundingClientRect(),
                            o = s.globals.minYArr[t] + (s.globals.maxYArr[t] - s.globals.minYArr[t] - (e - n.top) * i.yRatio[t]);
                        a.tooltipPosition.moveYCrosshairs(e - n.top), a.yaxisTooltipText[t].innerHTML = r(o), a.tooltipPosition.moveYAxisTooltip(t)
                    }
                }
            }]), t
        }(),
        xt = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    }, i.e = s, !i.tooltipUtil.hasBars() || r.globals.comboCharts || i.isBarShared || this.tConfig.onDatasetHover.highlightDataSeries && new M(e).toggleSeriesOnHover(s, s.target.parentNode), i.fixedTooltip && i.drawFixedTooltipRect(), r.globals.axisCharts ? i.axisChartsTooltips({
                        e: s,
                        opt: a,
                ...
                value: function (t) {
                    ...
                    if ("mousemove" === e.type || "touchmove" === e.type) {
                        ...
                        var l = s.globals.clientY - o.top - a.ttHeight - 10;
                        if (n.style.left = s.globals.clientX - o.left - a.ttWidth / 2 + "px", n.style.top = l + "px", s.config.legend.tooltipHoverFormatter) {
                            var h = r - 1,
                ...
                value: function () {
                    for (var t = this.w, e = new x(this.ctx), i = t.globals.dom.Paper.select(".apexcharts-bar-area"), a = 0; a < i.length; a++) e.pathMouseLeave(i[a])
                }
            }, {
                key: "handleMouseOut",
                value: function (t) {
                ...
                value: function (t, e, i, a, s) {
                    ...
                    if (n.config.legend.tooltipHoverFormatter) {
                        ...
                        for (var g = 0; g < d.length; g++) {
                            ...
                            if (r) u.innerHTML = n.globals.collapsedSeriesIndices.indexOf(p) < 0 ? b : f;
                            else if (u.innerHTML = p === i ? b : f, i === p) break
                        }
                    }
                    if (r) {
        ...
        bt = function (t) {
            ...
            return a(s, [{
                ...
                value: function (t, e) {
                    var i = this,
                        a = this.w;
                    this.graphics = new x(this.ctx), this.bar = new E(this.ctx, this.xyRatios);
                    var s = new v(this.ctx, a);
                    ...
                    for (var o = this.graphics.group({
                            ...
                            var m = i.graphics.group({
                                class: "apexcharts-series",
                                seriesName: u.escapeString(a.globals.seriesNames[b]),
                                rel: s + 1,
                                "data:realIndex": b
                            });
                            ...
                            var v = i.graphics.group({
                                ...
                                y = 0,
                                w = 0,
                                k = i.initialPositions(l, h, c, d, g, p);
                            h = k.y, y = k.barHeight, d = k.yDivision, p = k.zeroW, l = k.x, w = k.barWidth, c = k.xDivision, g = k.zeroH, i.yArrj = [], i.yArrjF = [], i.yArrjVal = [], i.xArrj = [], i.xArrjF = [], i.xArrjVal = [], 1 === i.prevY.length && i.prevY[0].every((function (t) {
                                return isNaN(t)
                            ...
                            for (var A = 0; A < a.globals.dataPoints; A++) {
                                ...
                                i.isHorizontal ? (L = i.drawStackedBarPaths(n(n({}, C), {}, {
                                    ...
                                    barWidth: w,
                                    zeroH: g
                                })), y = i.series[s][A] / i.yRatio[i.yaxisIndex]), h = L.y, f.push(l = L.x), x.push(h);
                            ...
                            a.globals.seriesXvalues[b] = f, a.globals.seriesYvalues[b] = x, i.prevY.push(i.yArrj), i.prevYF.push(i.yArrjF), i.prevYVal.push(i.yArrjVal), i.prevX.push(i.xArrj), i.prevXF.push(i.xArrjF), i.prevXVal.push(i.xArrjVal), o.add(m)
                ...
                value: function (t) {
                    for (var e, i, a = t.indexes, s = t.barHeight, r = t.strokeWidth, n = t.zeroW, o = t.y, l = t.yDivision, h = t.elSeries, c = this.w, d = o, g = a.i, u = a.j, p = 0, f = 0; f < this.prevXF.length; f++) p += this.prevXF[f][u];
                    if (g > 0) {
                        var x = n;
            ...
            return a(s, [{
                ...
                value: function (t, e) {
                    ...
                    for (var o = s.group({
                            ...
                            t[n].length > 0 && (i.visibleI = i.visibleI + 1), i.yRatio.length > 1 && (i.yaxisIndex = b);
                            var v = i.barHelpers.initialPositions();
                            p = v.y, c = v.barHeight, l = v.xDivision, h = v.zeroH, x.push((g = v.x) + (d = v.barWidth) / 2);
                            for (var y = s.group({
                                    class: "apexcharts-datalabels",
                                    "data:realIndex": b
                                }), w = function (e) {
                                    var s = i.barHelpers.getStrokeWidth(n, e, b),
                                        o = i.drawBoxPaths({
                                            indexes: {
                                                i: n,
                                                j: e,
                                    ...
                                    p = o.y, g = o.x, e > 0 && x.push(g + d / 2), f.push(p), o.pathTo.forEach((function (l, h) {
                                        var u = !i.isBoxPlot && i.candlestickOptions.wick.useFillColor ? o.color[h] : a.globals.stroke.colors[n],
                                            f = r.fillPath({
                                                seriesNumber: b,
                                                dataPointIndex: e,
                                                color: o.color[h],
                            ...
                            a.globals.seriesXvalues[b] = x, a.globals.seriesYvalues[b] = f, o.add(m)
                ...
                value: function (t) {
                    ...
                    var w = Math.min(m.o, m.c),
                        k = Math.max(m.o, m.c),
                        A = m.m;
                    o.globals.isXNumeric && (i = (o.globals.seriesX[b][c] - o.globals.minX) / this.xRatio - s / 2);
                    var S = i + s * this.visibleI;
                    null == this.series[h][c] ? (w = r, k = r) : (w = r - w / f, k = r - k / f, v = r - m.h / f, y = r - m.l / f, A = r - m.m / f);
                    var C = l.move(S, r),
                        L = l.move(S + s / 2, w);
                    return o.globals.previousPaths.length > 0 && (L = this.getPreviousPath(b, c, !0)), C = this.isBoxPlot ? [l.move(S, w) + l.line(S + s / 2, w) + l.line(S + s / 2, v) + l.line(S + s / 4, v) + l.line(S + s - s / 4, v) + l.line(S + s / 2, v) + l.line(S + s / 2, w) + l.line(S + s, w) + l.line(S + s, A) + l.line(S, A) + l.line(S, w + n / 2), l.move(S, A) + l.line(S + s, A) + l.line(S + s, k) + l.line(S + s / 2, k) + l.line(S + s / 2, y) + l.line(S + s - s / 4, y) + l.line(S + s / 4, y) + l.line(S + s / 2, y) + l.line(S + s / 2, k) + l.line(S, k) + l.line(S, A) + "z"] : [l.move(S, k) + l.line(S + s / 2, k) + l.line(S + s / 2, v) + l.line(S + s / 2, k) + l.line(S + s, k) + l.line(S + s, w) + l.line(S + s / 2, w) + l.line(S + s / 2, y) + l.line(S + s / 2, w) + l.line(S, w) + l.line(S, k - n / 2)], L += l.move(S, w), o.globals.isXNumeric || (i += a), {
                        pathTo: C,
                        pathFrom: L,
                        x: i,
                        y: k,
        ...
        vt = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i, a) {
                    ...
                    s.globals.hasNegs || a ? r = s.config.plotOptions[t].reverseNegativeShade ? o.percent < 0 ? o.percent / 100 * (1.25 * n) : 1.25 * n * (1 - o.percent / 100) : o.percent <= 0 ? 1 - (1 + o.percent / 100) * n : (1 - o.percent / 100) * n : (r = 1 - o.percent / 100, "treemap" === t && (r = 1.25 * n * (1 - o.percent / 100)));
                    var l = o.color,
                        h = new u;
                    return s.config.plotOptions[t].enableShades && (l = u.hexToRgba(h.shadeColor("dark" === this.w.config.theme.mode ? -1 * r : r, o.color), s.config.fill.opacity)), {
                        color: l,
                        colorProps: o
                    }
                }
        ...
        yt = function () {
            function t(i, a) {
                e(this, t), this.ctx = i, this.w = i.w, this.xRatio = a.xRatio, this.yRatio = a.yRatio, this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.helpers = new vt(i), this.rectRadius = this.w.config.plotOptions.heatmap.radius, this.strokeWidth = this.w.config.stroke.show ? this.w.config.stroke.width : 0
            }
            return a(t, [{
                key: "draw",
                value: function (t) {
                    ...
                    for (var h = o ? 0 : l.length - 1; o ? h < l.length : h >= 0; o ? h++ : h--) {
                        ...
                        if (this.ctx.series.addCollapsedClassToSeries(c, h), e.config.chart.dropShadow.enabled) {
                            ...
                            new f(this.ctx).dropShadow(c, d, h)
                        }
                        for (var g = 0, p = e.config.plotOptions.heatmap.shadeIntensity, b = 0; b < l[h].length; b++) {
                            var m = this.helpers.getShadeColor(e.config.chart.type, h, b, this.negRange),
                                v = m.color,
                                y = m.colorProps;
                            "image" === e.config.fill.type && (v = new C(this.ctx).fillPath({
                                seriesNumber: h,
                                dataPointIndex: b,
                                opacity: e.globals.hasNegs ? y.percent < 0 ? 1 - (1 + y.percent / 100) : p + y.percent / 100 : y.percent / 100,
                                patternID: u.randomId(),
                            ...
                            var w = i.drawRect(g, n, s, r, this.rectRadius);
                            if (w.attr({
                                    cx: g,
                                    cy: n
                                ...
                                var k = 1;
                                e.globals.resized || (k = e.config.chart.animations.speed), this.animateHeatMap(w, g, n, s, r, k)
                            }
                            if (e.globals.dataChanged) {
                                var A = 1;
                                if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                                    A = this.dynamicAnim.speed;
                                    var S = e.globals.previousPaths[h] && e.globals.previousPaths[h][b] && e.globals.previousPaths[h][b].color;
                                    S || (S = "rgba(255, 255, 255, 0)"), this.animateHeatColor(w, u.isColorHex(S) ? S : u.rgb2hex(S), u.isColorHex(v) ? v : u.rgb2hex(v), A)
                                }
                            }
                            var L = (0, e.config.dataLabels.formatter)(e.globals.series[h][b], {
                                    value: e.globals.series[h][b],
                                    seriesIndex: h,
                                    dataPointIndex: b,
                                    w: e
                                }),
                    ...
                    return e.config.yaxis[0].reversed ? T.unshift("") : T.push(""), e.globals.yAxisScale[0].result = T, e.config.yaxis[0].labels.offsetY = -e.globals.gridHeight / e.globals.series.length / 2, a
                }
            }, {
                key: "animateHeatMap",
                value: function (t, e, i, a, s, r) {
        ...
        kt = function () {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    for (var s = 0, r = 0; r < t.length; r++) s += u.negToZero(t[r]);
                    var n = [],
                        o = a.group();
                    ...
                    if (i.globals.dataChanged) {
                        for (var c, d = 0, g = 0; g < i.globals.previousPaths.length; g++) d += u.negToZero(i.globals.previousPaths[g]);
                        for (var p = 0; p < i.globals.previousPaths.length; p++) c = this.fullAngle * u.negToZero(i.globals.previousPaths[p]) / d, this.prevSectorAngleArr.push(c)
                    }
                    this.donutSize < 0 && (this.donutSize = 0);
                    var f = i.config.plotOptions.pie.customScale,
                        b = i.globals.gridWidth / 2 - i.globals.gridWidth / 2 * f,
                ...
                value: function (t, e) {
                    ...
                    for (var d = 0; d < t.length; d++) {
                        ...
                        n.add(g), h = (o = h) + t[d], c = (l = c) + this.prevSectorAngleArr[d];
                        var p = h < o ? this.fullAngle + h - o : h - o,
                            b = r.fillPath({
                                seriesNumber: d,
                        ...
                        v.attr({
                            index: 0,
                            j: d
                        }), a.setSelectionFilter(v, 0, d), i.config.chart.dropShadow.enabled && a.dropShadow(v, i.config.chart.dropShadow, d), this.addListeners(v, this.donutDataLabels), x.setAttrs(v.node, {
                            "data:angle": p,
                            "data:startAngle": o,
                        ...
                        "pie" === this.chartType || "polarArea" === this.chartType ? y = u.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize / 1.25 + i.config.plotOptions.pie.dataLabels.offset, (o + p / 2) % this.fullAngle) : "donut" === this.chartType && (y = u.polarToCartesian(this.centerX, this.centerY, (i.globals.radialSize + this.donutSize) / 2 + i.config.plotOptions.pie.dataLabels.offset, (o + p / 2) % this.fullAngle)), g.add(v);
                        var w = 0;
                        if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (w = p / this.fullAngle * i.config.chart.animations.speed) && (w = 1), this.animDur = w + this.animDur, this.animBeginArr.push(this.animDur)), this.animatePaths(v, this.dynamicAnim && i.globals.dataChanged ? {
                                size: this.sliceSizes[d],
                                endAngle: h,
                                startAngle: o,
                                prevStartAngle: l,
                            ...
                            if (0 !== p && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                                ...
                                T.add(z), i.config.dataLabels.dropShadow.enabled && a.dropShadow(z, i.config.dataLabels.dropShadow), z.node.classList.add("apexcharts-pie-label"), i.config.chart.animations.animate && !1 === i.globals.resized && (z.node.classList.add("apexcharts-pie-label-delay"), z.node.style.animationDelay = i.config.chart.animations.speed / 940 + "s"), this.sliceLabels.push(T)
                            }
                        }
                    }
                    return n
                ...
                value: function (t) {
                    ...
                    var l = Math.PI * (o - 90) / 180,
                        ...
                        p = u.polarToCartesian(e.centerX, e.centerY, e.donutSize, o),
                        f = u.polarToCartesian(e.centerX, e.centerY, e.donutSize, r),
                        x = a > 180 ? 1 : 0,
                        b = ["M", h, c, "A", s, s, 0, x, 1, d, g];
                    return "donut" === e.chartType ? [].concat(b, ["L", p.x, p.y, "A", e.donutSize, e.donutSize, 0, x, 0, f.x, f.y, "L", h, c, "z"]).join(" ") : "pie" === e.chartType || "polarArea" === e.chartType ? [].concat(b, ["L", e.centerX, e.centerY, "L", h, c]).join(" ") : [].concat(b).join(" ")
                }
            }, {
                ...
                value: function (t, e, i, a) {
                    ...
                    i = (0, t.value.formatter)(i, r), a || "function" != typeof t.total.formatter || (i = t.total.formatter(r)), e = t.name.formatter(e, e === t.total.label, r), null !== n && (n.textContent = e), null !== o && (o.textContent = i), null !== n && (n.style.fill = s)
                }
            }, {
                ...
                value: function (t) {
                    ...
                    if (0 !== s.strokeWidth) {
                        for (var r = [], n = 360 / i.globals.series.length, o = 0; o < i.globals.series.length; o++) r.push(u.polarToCartesian(this.centerX, this.centerY, i.globals.radialSize, i.config.plotOptions.pie.startAngle + n * o));
        ...
        At = function () {
            function t(i) {
                ...
                var a = this.w;
                this.graphics = new x(this.ctx), this.lineColorArr = void 0 !== a.globals.stroke.colors ? a.globals.stroke.colors : a.globals.colors, this.defaultSize = a.globals.svgHeight < a.globals.svgWidth ? a.globals.gridHeight + 1.5 * a.globals.goldenPadding : a.globals.gridWidth, this.isLog = a.config.yaxis[0].logarithmic, this.coreUtils = new v(this.ctx), this.maxValue = this.isLog ? this.coreUtils.getLogVal(a.globals.maxY, 0) : a.globals.maxY, this.minValue = this.isLog ? this.coreUtils.getLogVal(this.w.globals.minY, 0) : a.globals.minY, this.polygons = a.config.plotOptions.radar.polygons, this.strokeWidth = a.config.stroke.show ? a.config.stroke.width : 0, this.size = this.defaultSize / 2.1 - this.strokeWidth - a.config.chart.dropShadow.blur, a.config.xaxis.labels.show && (this.size = this.size - a.globals.xAxisLabelsWidth / 1.75), void 0 !== a.config.plotOptions.radar.size && (this.size = a.config.plotOptions.radar.size), this.dataRadiusOfPercent = [], this.dataRadius = [], this.angleArr = [], this.yaxisLabelsTextsPos = []
            }
            return a(t, [{
                key: "draw",
                value: function (t) {
                    ...
                    var o = i.globals.gridHeight / 2 + i.config.plotOptions.radar.offsetY,
                        l = this.graphics.group({
                            class: "apexcharts-radar-series apexcharts-plot-series",
                            transform: "translate(".concat(i.globals.gridWidth / 2 + i.config.plotOptions.radar.offsetX || 0, ", ").concat(o || 0, ")")
                        }),
                        h = [],
                        c = null,
                        d = null;
                    if (this.yaxisLabels = this.graphics.group({
                            ...
                            var l = t.length === i.globals.dataPoints,
                                g = e.graphics.group().attr({
                                    class: "apexcharts-series",
                                    "data:longestSeries": l,
                                    seriesName: u.escapeString(i.globals.seriesNames[o]),
                                    rel: o + 1,
                                    "data:realIndex": o
                                });
                            ...
                            for (var m = 0; m < p.linePathsTo.length; m++) {
                                var v = e.graphics.renderPaths(n(n({}, x), {}, {
                                ...
                                var y = a.fillPath({
                                    ...
                                    w = e.graphics.renderPaths(n(n({}, x), {}, {
                                ...
                                i.config.chart.dropShadow.enabled && new f(e.ctx).dropShadow(w, Object.assign({}, i.config.chart.dropShadow, {
                                    noUserSpaceOnUse: !0
                                }), o), g.add(w)
                            }
                            t.forEach((function (t, a) {
                                var s = new L(e.ctx).getMarkerConfig("apexcharts-marker", o, a),
                                    l = e.graphics.drawMarker(h[a].x, h[a].y, s);
                                l.attr("rel", a), l.attr("j", a), l.attr("index", o), l.node.setAttribute("default-marker-size", s.pSize);
                                var u = e.graphics.group({
                                    class: "apexcharts-series-markers"
                                });
                                u && u.add(l), c.add(u), g.add(c);
                                var p = i.config.dataLabels;
                                if (p.enabled) {
                                    var f = p.formatter(i.globals.series[o][a], {
                                        seriesIndex: o,
                                        dataPointIndex: a,
                                        w: i
                                    });
                ...
                value: function (t) {
                    ...
                    o.forEach((function (t, i) {
                        var a = u.getPolygonPos(t, e.dataPointsLen),
                            s = "";
                ...
                value: function () {
                    var t = this,
                        ...
                        s = u.getPolygonPos(this.size, this.dataPointsLen);
            ...
            return a(s, [{
                ...
                value: function (t) {
                    ...
                    for (var o = 0; o < t.series.length; o++) {
                        ...
                        h.dropShadow.enabled && s.dropShadow(u, h.dropShadow), l.add(u), u.attr("id", "apexcharts-radialbarTrack-" + o), this.animatePaths(u, {
                            centerX: t.centerX,
                            centerY: t.centerY,
                            endAngle: g,
                            startAngle: d,
                ...
                value: function (t) {
                    ...
                    for (var b = p ? t.series.length - 1 : 0; p ? b >= 0 : b < t.series.length; p ? b-- : b++) {
                        var m = i.group({
                            class: "apexcharts-series apexcharts-radial-series",
                            seriesName: u.escapeString(e.globals.seriesNames[b])
                        });
                        r.add(m), m.attr({
                            rel: b + 1,
                            "data:realIndex": b
                        }), this.ctx.series.addCollapsedClassToSeries(m, b), t.size = t.size - n - this.margin;
                        var v = a.fillPath({
                                seriesNumber: b,
                                size: t.size,
                                value: t.series[b]
                            ...
                            y = this.startAngle,
                            w = void 0,
                            k = u.negToZero(t.series[b] > 100 ? 100 : t.series[b]) / 100,
                            A = Math.round(this.totalAngle * k) + this.startAngle,
                            S = void 0;
                        e.globals.dataChanged && (w = this.startAngle, S = Math.round(this.totalAngle * u.negToZero(e.globals.previousPaths[b]) / 100) + w), Math.abs(A) + Math.abs(y) >= 360 && (A -= .01), Math.abs(S) + Math.abs(w) >= 360 && (S -= .01);
                        var L = A - y,
                            P = Array.isArray(e.config.stroke.dashArray) ? e.config.stroke.dashArray[b] : e.config.stroke.dashArray,
                            T = i.drawPath({
                                d: "",
                                stroke: v,
                                strokeWidth: n,
                        ...
                        }), e.config.chart.dropShadow.enabled && s.dropShadow(T, e.config.chart.dropShadow, b), s.setSelectionFilter(T, 0, b), this.addListeners(T, this.radialDataLabels), m.add(T), T.attr({
                            index: 0,
                            j: b
                        });
                        var z = 0;
                        !this.initialAnim || e.globals.resized || e.globals.dataChanged || (this.animDur = (z = (A - y) / 360 * e.config.chart.animations.speed) / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur)), e.globals.dataChanged && (this.animDur = (z = (A - y) / 360 * e.config.chart.animations.dynamicAnimation.speed) / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur)), this.animatePaths(T, {
                            centerX: t.centerX,
                            centerY: t.centerY,
                            endAngle: A,
                            startAngle: y,
        ...
        Ct = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    var i = this.w;
                    if ("line" === i.config.chart.type && ("gradient" === i.config.fill.type || "gradient" === i.config.fill.type[t]) && new v(this.lineCtx.ctx, i).seriesHaveSameValues(t)) {
                        var a = e[t].slice();
                ...
                value: function (t) {
                    var e = t.series,
                        ...
                        h = [];
                    if (0 === r) {
                        var c = this.lineCtx.categoryAxisCorrection + o.config.markers.offsetX;
                        o.globals.isXNumeric && (c = (o.globals.seriesX[t.realIndex][0] - o.globals.minX) / this.lineCtx.xRatio + o.config.markers.offsetX), l.push(c), h.push(u.isNumber(e[s][0]) ? n + o.config.markers.offsetY : null), l.push(i + o.config.markers.offsetX), h.push(u.isNumber(e[s][r + 1]) ? a + o.config.markers.offsetY : null)
                    } else l.push(i + o.config.markers.offsetX), h.push(u.isNumber(e[s][r + 1]) ? a + o.config.markers.offsetY : null);
                    return {
                        x: l,
                        y: h
                    }
        ...
        Lt = function () {
            function t(i, a, s) {
                e(this, t), this.ctx = i, this.w = i.w, this.xyRatios = a, this.pointsChart = !("bubble" !== this.w.config.chart.type && "scatter" !== this.w.config.chart.type) || s, this.scatter = new P(this.ctx), this.noNegatives = this.w.globals.minX === Number.MAX_VALUE, this.lineHelpers = new Ct(this), this.markers = new L(this.ctx), this.prevSeriesY = [], this.categoryAxisCorrection = 0, this.yaxisIndex = 0
            }
            return a(t, [{
                key: "draw",
                value: function (t, e, i) {
                ...
                value: function (t, e, i) {
                    ...
                    this.xDivision = a.globals.gridWidth / (a.globals.dataPoints - ("on" === a.config.xaxis.tickPlacement ? 1 : 0)), this.strokeWidth = Array.isArray(a.config.stroke.width) ? a.config.stroke.width[i] : a.config.stroke.width, this.yRatio.length > 1 && (this.yaxisIndex = i), this.isReversed = a.config.yaxis[this.yaxisIndex] && a.config.yaxis[this.yaxisIndex].reversed, this.zeroY = a.globals.gridHeight - this.baseLineY[this.yaxisIndex] - (this.isReversed ? a.globals.gridHeight : 0) + (this.isReversed ? 2 * this.baseLineY[this.yaxisIndex] : 0), this.areaBottomY = this.zeroY, (this.zeroY > a.globals.gridHeight || "end" === a.config.plotOptions.area.fillTo) && (this.areaBottomY = a.globals.gridHeight), this.categoryAxisCorrection = this.xDivision / 2, this.elSeries = s.group({
                        class: "apexcharts-series",
                        seriesName: u.escapeString(a.globals.seriesNames[i])
                ...
                value: function (t) {
                    ...
                    if (null === r[n][0]) {
                        for (var g = 0; g < r[n].length; g++)
                            if (null !== r[n][g]) {
                                e = d.move(l = this.xDivision * g, h = this.zeroY - r[n][g] / this.yRatio[this.yaxisIndex]), i = d.move(l, this.areaBottomY);
                                break
                            }
                ...
                value: function (t) {
                    for (var e = t.series, i = t.realIndex, a = t.i, s = t.x, r = t.y, n = t.pX, o = t.pY, l = t.pathsFrom, h = t.linePaths, c = t.areaPaths, d = t.seriesIndex, g = t.lineYPosition, p = t.xArrj, f = t.yArrj, b = this.w, m = new x(this.ctx), v = this.yRatio, y = l.prevY, w = l.linePath, k = l.areaPath, A = l.pathFromLine, S = l.pathFromArea, C = u.isNumber(b.globals.minYArr[i]) ? b.globals.minYArr[i] : b.globals.minY, L = b.globals.dataPoints > 1 ? b.globals.dataPoints - 1 : b.globals.dataPoints, P = 0; P < L; P++) {
                        var T = null == e[a][P + 1];
                        ...
                        }(a - 1)][P + 1] : this.zeroY, r = T ? g - C / v[this.yaxisIndex] + 2 * (this.isReversed ? C / v[this.yaxisIndex] : 0) : g - e[a][P + 1] / v[this.yaxisIndex] + 2 * (this.isReversed ? e[a][P + 1] / v[this.yaxisIndex] : 0), p.push(s), f.push(r);
                ...
                value: function (t) {
                    var e = t.series,
                        ...
                        m = this.areaBottomY;
                    if (Array.isArray(p.config.stroke.curve) && (b = Array.isArray(u) ? p.config.stroke.curve[u[i]] : p.config.stroke.curve[i]), "smooth" === b) {
                        var v = .35 * (r - o);
                        p.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (h = f.move(o, l) + f.curve(o + v, l, r - v, n, r + 1, n), c = f.move(o + 1, l) + f.curve(o + v, l, r - v, n, r + 1, n) + f.line(r, m) + f.line(o, m) + "z") : (h = f.move(o, l), c = f.move(o, l) + "z")), d.push(h), g.push(c)) : (h += f.curve(o + v, l, r - v, n, r, n), c += f.curve(o + v, l, r - v, n, r, n)), o = r, l = n, s === e[i].length - 2 && (c = c + f.curve(o, l, r, n, r, m) + f.move(r, n) + "z", p.globals.hasNullValues || (d.push(h), g.push(c)))
                    } else null === e[i][s + 1] && (h += f.move(r, n), c = c + f.line(p.globals.isXNumeric ? (p.globals.seriesX[a][s] - p.globals.minX) / this.xRatio : r - this.xDivision, m) + f.move(r, n) + "z"), null === e[i][s] && (h += f.move(r, n), c += f.move(r, m)), "stepline" === b ? (h = h + f.line(r, null, "H") + f.line(null, n, "V"), c = c + f.line(r, null, "H") + f.line(null, n, "V")) : "straight" === b && (h += f.line(r, n), c += f.line(r, n)), s === e[i].length - 2 && (c = c + f.line(r, m) + f.move(r, n) + "z", d.push(h), g.push(c));
                    return {
                        linePaths: d,
                        areaPaths: g,
                        pX: o,
    ...
    var Pt, Tt, zt = function () {
            function t(i, a) {
                e(this, t), this.ctx = i, this.w = i.w, this.strokeWidth = this.w.config.stroke.width, this.helpers = new vt(i), this.dynamicAnim = this.w.config.chart.animations.dynamicAnimation, this.labels = []
            }
            return a(t, [{
                key: "draw",
                value: function (t) {
                    ...
                    return t.forEach((function (t) {
                        ...
                        n.forEach((function (r, n) {
                            var h = r[0],
                                ...
                                d = r[2],
                                g = r[3],
                                u = a.drawRect(h, c, d - h, g - c, 0, "#fff", 1, e.strokeWidth, i.config.plotOptions.treemap.useFillColorAsStroke ? f : i.globals.stroke.colors[o]);
                            u.attr({
                                cx: h,
                                cy: c,
                                index: o,
                            ...
                            var p = e.helpers.getShadeColor(i.config.chart.type, o, n, e.negRange),
                                f = p.color;
                            void 0 !== i.config.series[o].data[n] && i.config.series[o].data[n].fillColor && (f = i.config.series[o].data[n].fillColor);
                            var x = s.fillPath({
                                color: f,
                                seriesNumber: o,
                                dataPointIndex: n
                            ...
                            i.globals.dataChanged && e.dynamicAnim.enabled && i.globals.shouldAnimate && (i.globals.previousPaths[o] && i.globals.previousPaths[o][n] && i.globals.previousPaths[o][n].rect && (b = i.globals.previousPaths[o][n].rect), e.animateTreemap(u, b, m, e.dynamicAnim.speed));
                            var y = e.getFontSize(r),
                                w = i.config.dataLabels.formatter(e.labels[o][n], {
                            ...
                            i.config.dataLabels.enabled && k && e.rotateToFitLabel(k, w, h, c, d, g), l.add(u), null !== k && l.add(k)
                        })), l.add(c), r.add(l)
                    })), r
                }
            }, {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    if (e.minDate > 1 || e.minMonth > 0) {
                        ...
                        o = (l.determineDaysOfYear(e.minYear) - c + 1) * s, this.timeScaleArray.push({
                            position: o,
                            value: n = e.minYear + 1,
                            unit: h,
                            year: n,
                    ...
                    for (var d = n, g = o, p = 0; p < r; p++) d++, g = l.determineDaysOfYear(d - 1) * s + g, this.timeScaleArray.push({
                        position: g,
                        value: d,
                        unit: h,
                        year: d,
                ...
                value: function (t) {
                    var e = t.firstVal,
                        ...
                        d = 0;
                    if (e.minDate > 1) {
                        l = (h.determineDaysOfMonths(a + 1, e.minYear) - i + 1) * r, o = u.monthMod(a + 1);
                        var g = s + d,
                            p = u.monthMod(o),
                            f = o;
                        0 === o && (c = "year", f = g, p = 1, g += d += 1), this.timeScaleArray.push({
                            position: l,
                            value: f,
                            unit: c,
                            year: g,
                ...
                value: function (t) {
                    var e = t.firstVal,
                        ...
                        g = l,
                        p = c(h, i, a);
                    0 === e.minHour && 1 === e.minDate ? (d = 0, g = u.monthMod(e.minMonth), o = "month", h = e.minDate, r++) : 1 !== e.minDate && 0 === e.minHour && 0 === e.minMinute && (d = 0, g = l = e.minDate, p = c(h = l, i, a)), this.timeScaleArray.push({
                        position: d,
                        value: g,
                        unit: o,
                    ...
                    for (var f = d, x = 0; x < r; x++) {
                        o = "day", p = c(h += 1, p, this._getYear(a, p, 0));
                        var b = this._getYear(a, p, 0);
                        f = 24 * s + f;
                        var m = 1 === h ? u.monthMod(p) : h;
                ...
                value: function (t) {
                    for (var e = t.minutesWidthOnXAxis, i = t.numberOfMinutes, a = t.currentMinute + 1, s = t.currentDate, r = t.currentMonth, n = t.currentYear, o = t.currentHour, l = (60 - t.currentSecond - t.currentMillisecond / 1e3) * t.secondsWidthOnXAxis, h = 0; h < i; h++) a >= 60 && (a = 0, 24 === (o += 1) && (o = 0)), this.timeScaleArray.push({
                        position: l,
                        value: a,
                        unit: "minute",
                        hour: o,
                ...
                value: function (t) {
                    for (var e = t.secondsWidthOnXAxis, i = t.numberOfSeconds, a = t.currentSecond + 1, s = t.currentMinute, r = t.currentDate, n = t.currentMonth, o = t.currentYear, l = t.currentHour, h = (1e3 - t.currentMillisecond) / 1e3 * e, c = 0; c < i; c++) a >= 60 && (a = 0, ++s >= 60 && (s = 0, 24 == ++l && (l = 0))), this.timeScaleArray.push({
                        position: h,
                        value: a,
                        unit: "second",
                        hour: l,
                ...
                value: function (t) {
                    ...
                    return t.map((function (n, o) {
                        if (o > 0 && i.w.config.xaxis.labels.hideOverlappingLabels) {
                            ...
                            return n.position > t[r].position + l + 10 ? (r = o, n) : null
                        }
                        return n
                    })).filter((function (t) {
                        return null !== t
        ...
        It = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    ...
                    if (s.comboCharts) {
                        ...
                        case "area":
                            ...
                            break;
                        case "bar":
                            a.chart.stacked ? x = new bt(this.ctx, e).draw(s.series) : (this.ctx.bar = new E(this.ctx, e), x = this.ctx.bar.draw(s.series));
                            break;
                        case "candlestick":
                        case "boxPlot":
                ...
                value: function () {
                    ...
                    "%" === a ? u.isNumber(i[0]) && (0 === i[0].width && (i = u.getDimensions(this.el.parentNode)), t.svgWidth = i[0] * parseInt(e.chart.width, 10) / 100) : "px" !== a && "" !== a || (t.svgWidth = parseInt(e.chart.width, 10));
                    var s = e.chart.height.toString().split(/[0-9]+/g).pop();
                    if ("auto" !== t.svgHeight && "" !== t.svgHeight)
                        if ("%" === s) {
                            var r = u.getDimensions(this.el.parentNode);
                    ...
                    t.svgWidth < 0 && (t.svgWidth = 0), t.svgHeight < 0 && (t.svgHeight = 0), x.setAttrs(t.dom.Paper.node, {
                        width: t.svgWidth,
                        height: t.svgHeight
                ...
                value: function () {
                    ...
                    if (s && !t.config.chart.sparkline.enabled) {
                        var n = u.getBoundingClientRect(s);
                        r = n.bottom, r = Math.max(2.05 * t.globals.radialSize, n.bottom - n.top)
                    }
                    var o = r + e.translateY + i + a;
                    e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", o), e.dom.elWrap.style.height = o + "px", x.setAttrs(e.dom.Paper.node, {
                        height: o
                ...
                value: function () {
                    ...
                    if (e.globals.axisCharts) {
                        if ("back" === e.config.xaxis.crosshairs.position && new J(this.ctx).drawXCrosshairs(), "back" === e.config.yaxis[0].crosshairs.position && new J(this.ctx).drawYCrosshairs(), "datetime" === e.config.xaxis.type && void 0 === e.config.xaxis.labels.formatter) {
                        ...
                        i.forEach((function (e) {
                            ...
                            i.forEach((function (t) {
                                ...
                                var o = i.w.config.yaxis.reduce((function (t, e, a) {
                                    return [].concat(d(t), [n(n({}, i.w.config.yaxis[a]), {}, {
                                        min: s[0].min,
                                        max: s[0].max
                                    })])
                                }), []);
            ...
            return a(i, [{
                ...
                value: function (t, e) {
                    ...
                    return r.globals.shouldAnimate = e, r.globals.dataChanged = !0, e && this.ctx.series.getPreviousPaths(), r.globals.axisCharts ? (0 === (i = t.map((function (t, e) {
                        ...
                        data: []
                    }]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = u.clone(r.config.series)), this.ctx.update()
                }
            }, {
                key: "_extendSeries",
                value: function (t, e) {
                ...
                value: function (t, e) {
                    ...
                    return i.globals.axisCharts ? a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(e, "'], ").concat(s, " circle[j='").concat(e, "'], ").concat(s, " rect[j='").concat(e, "']")).members[0] : void 0 === e && (a = i.globals.dom.Paper.select("".concat(s, " path[j='").concat(t, "']")).members[0], "pie" !== i.config.chart.type && "polarArea" !== i.config.chart.type && "donut" !== i.config.chart.type || this.ctx.pie.pieClicked(t)), a ? (new x(this.ctx).pathMouseDown(a, null), a.node ? a.node : null) : (console.warn("toggleDataPointSelection: Element not found"), null)
                }
            }, {
    ...
    Pt = "undefined" != typeof window ? window : void 0, Tt = function (e, i) {
            ...
            a.PathArray = function (t, e) {
                ...
                fire: function (t, i) {
                    return this.node.dispatchEvent(t instanceof e.Event ? t : t = new a.CustomEvent(t, {
                        detail: i,
                        cancelable: !0
                    })), this._event = t, this
                },
        ...
        })) : "object" === ("undefined" == typeof exports ? "undefined" : t(exports)) && "undefined" != typeof module ? module.exports = Pt.document ? Tt(Pt, Pt.document) : function (t) {
            return Tt(t, t.document)
        } : Pt.SVG = Tt(Pt, Pt.document), (function () {
                ...
                switch (t[0]) {
                    ...
                    case "A":
                        t = (e = function (t, e) {
                            ...
                            for ((a = (i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform((new SVG.Matrix).rotate(M))).x * i.x / (T * T) + i.y * i.y / (z * z)) > 1 && (T *= a = Math.sqrt(a), z *= a), s = (new SVG.Matrix).rotate(M).scale(1 / T, 1 / z).rotate(-M), F = F.transform(s), o = (r = [(R = R.transform(s)).x - F.x, R.y - F.y])[0] * r[0] + r[1] * r[1], n = Math.sqrt(o), r[0] /= n, r[1] /= n, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, I === E && (l *= -1), h = new SVG.Point((R.x + F.x) / 2 + l * -r[1], (R.y + F.y) / 2 + l * r[0]), c = new SVG.Point(F.x - h.x, F.y - h.y), d = new SVG.Point(R.x - h.x, R.y - h.y), g = Math.acos(c.x / Math.sqrt(c.x * c.x + c.y * c.y)), c.y < 0 && (g *= -1), u = Math.acos(d.x / Math.sqrt(d.x * d.x + d.y * d.y)), d.y < 0 && (u *= -1), E && g > u && (u += 2 * Math.PI), !E && g < u && (u -= 2 * Math.PI), b = [], m = g, p = (u - g) / (f = Math.ceil(2 * Math.abs(g - u) / Math.PI)), x = 4 * Math.tan(p / 4) / 3, k = 0; k <= f; k++) y = Math.cos(m), v = Math.sin(m), w = new SVG.Point(h.x + y, h.y + v), b[k] = [new SVG.Point(w.x + x * v, w.y - x * y), w, new SVG.Point(w.x - x * v, w.y + x * y)], m += p;
                            ...
                            for (k = 1, A = b.length; k < A; k++) S = (w = b[k - 1][2]).x, C = w.y, L = (w = b[k][0]).x, P = w.y, X = (w = b[k][1]).x, D.push(["C", S, C, L, P, X, Y = w.y]);
                            return D
                        }(this.pos, t))[0]
                }
    ...
    var Xt = function () {
            ...
            return a(t, [{
                key: "initModules",
                value: function () {
                    this.ctx.publicMethods = ["updateOptions", "updateSeries", "appendData", "appendSeries", "toggleSeries", "showSeries", "hideSeries", "setLocale", "resetSeries", "zoomX", "toggleDataPointSelection", "dataURI", "addXaxisAnnotation", "addYaxisAnnotation", "addPointAnnotation", "clearAnnotations", "removeAnnotation", "paper", "destroy"], this.ctx.eventList = ["click", "mousedown", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], this.ctx.animations = new p(this.ctx), this.ctx.axes = new $(this.ctx), this.ctx.core = new It(this.ctx.el, this.ctx), this.ctx.config = new R({}), this.ctx.data = new O(this.ctx), this.ctx.grid = new G(this.ctx), this.ctx.graphics = new x(this.ctx), this.ctx.coreUtils = new v(this.ctx), this.ctx.crosshairs = new J(this.ctx), this.ctx.events = new q(this.ctx), this.ctx.exports = new B(this.ctx), this.ctx.localization = new Z(this.ctx), this.ctx.options = new A, this.ctx.responsive = new Q(this.ctx), this.ctx.series = new M(this.ctx), this.ctx.theme = new K(this.ctx), this.ctx.formatters = new N(this.ctx), this.ctx.titleSubtitle = new tt(this.ctx), this.ctx.legend = new ot(this.ctx), this.ctx.toolbar = new lt(this.ctx), this.ctx.dimensions = new rt(this.ctx), this.ctx.updateHelpers = new Et(this.ctx), this.ctx.zoomPanSelection = new ht(this.ctx), this.ctx.w.globals.tooltip = new xt(this.ctx)
                }
            }]), t
        }(),
        Yt = function () {
    ...
    return function () {
        ...
        return a(t, [{
            ...
            value: function (t, e) {
                ...
                var a = this.w.globals;
                if (a.noData = !1, a.animationEnded = !1, this.responsive.checkResponsiveConfig(e), i.config.xaxis.convertedCatToNumeric && new F(i.config).convertCatToNumericXaxis(i.config, this.ctx), null === this.el) return a.animationEnded = !0, null;
            ...
            value: function () {
                ...
                return new Promise((function (s, r) {
                    ...
                    i.annotations = new S(i), i.annotations.drawImageAnnos(), i.annotations.drawTextAnnos(), "back" === a.config.grid.position && n && a.globals.dom.elGraphical.add(n.el);
                    var o = new V(t.ctx),
                        l = new U(t.ctx);
            ...
            value: function () {
                ...
                t && Apex._chartInstances.forEach((function (e, i) {
                    e.id === u.escapeString(t) && Apex._chartInstances.splice(i, 1)
            ...
            value: function (t) {
                ...
                return i.w.config.series = a, e && (i.w.globals.initialSeries = u.clone(i.w.config.series)), this.update()
            }
        }, {
            key: "update",
            value: function (t) {
